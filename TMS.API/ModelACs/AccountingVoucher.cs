...
namespace TMS.API.ModelACs
{
    public partial class AccountingVoucher
    {
        ...
        {
            AccountingVoucherDetails = new HashSet<AccountingVoucherDetails>();
            AccountingVoucherDetailsSum = new HashSet<AccountingVoucherDetailsSum>();
        }
        ...
        public virtual ICollection<AccountingVoucherDetails> AccountingVoucherDetails { get; set; }
        public virtual ICollection<AccountingVoucherDetailsSum> AccountingVoucherDetailsSum { get; set; }
    }
}
