...
namespace TMS.API.ModelACs
{
    public partial class ACContext : DbContext
    {
        ...
        public virtual DbSet<OriginAccountingVoucher> OriginAccountingVoucher { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AccountingVoucher>(entity =>
            {
                ...
                entity.Property(e => e.BankOriginRefNo).HasMaxLength(50);

                entity.Property(e => e.CompanyAddress).HasMaxLength(250);

                entity.Property(e => e.CompanyName).HasMaxLength(50);

                entity.Property(e => e.FKEYRANDOM)
                    .HasMaxLength(250)
                    .HasDefaultValueSql("(('DA'+format(getdate(),'yyMM'))+replace(CONVERT([varchar](100),newid(),(0)),'-',''))");

                entity.Property(e => e.FreightPrice).HasColumnType("decimal(20, 5)");

                entity.Property(e => e.Items).HasMaxLength(250);

                entity.Property(e => e.Note).HasMaxLength(250);

                entity.Property(e => e.OriginRefFiles).HasMaxLength(500);

                entity.Property(e => e.OriginRefNo).HasMaxLength(50);

                entity.Property(e => e.OriginRefNum).HasMaxLength(50);

                entity.Property(e => e.Reason).HasMaxLength(250);

                entity.Property(e => e.ReceiverAccountNum)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.ReceiverAddressBank).HasMaxLength(250);

                entity.Property(e => e.ReceiverBankName).HasMaxLength(250);

                entity.Property(e => e.ReceiverName).HasMaxLength(250);

                entity.Property(e => e.ReceiverSwiftCode)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.TotalAmountAfterTax).HasColumnType("decimal(20, 5)");

                entity.Property(e => e.TotalAmountAfterTaxCy).HasColumnType("decimal(20, 5)");
            ...
            modelBuilder.Entity<AccountingVoucherDetails>(entity =>
            {
                entity.Property(e => e.Id).ValueGeneratedNever();
                ...
                entity.Property(e => e.OriginalCurrency).HasColumnType("decimal(20, 5)");
                ...
                entity.Property(e => e.StockQuantity).HasColumnType("decimal(20, 5)");
            ...
            modelBuilder.Entity<AccountingVoucherDetailsSum>(entity =>
            {
                ...
                entity.Property(e => e.AriseCredit).HasColumnType("decimal(20, 5)");

                entity.Property(e => e.AriseDebit).HasColumnType("decimal(20, 5)");
                ...
                entity.HasOne(d => d.AccountingVoucher)
                    .WithMany(p => p.AccountingVoucherDetailsSum)
                    .HasForeignKey(d => d.AccountingVoucherId)
                    .HasConstraintName("FK_AccountingVoucherDetailsSum_AccountingVoucher");
            });
            ...
            modelBuilder.Entity<InvoiceForm>(entity =>
            {
                ...
                entity.Property(e => e.StartInvoiceNo).HasColumnType("numeric(18, 0)");
            ...
            modelBuilder.Entity<Location>(entity =>
            {
                ...
                entity.Property(e => e.Description3).HasMaxLength(250);

                entity.Property(e => e.Description4).HasMaxLength(250);

                entity.Property(e => e.Description5).HasMaxLength(250);
            ...
            modelBuilder.Entity<OriginAccountingVoucher>(entity =>
            {
                entity.Property(e => e.AccountNum)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.RealTotalAmountAfterTax).HasColumnType("decimal(20, 5)");

                entity.Property(e => e.RealTotalAmountBeforeTax).HasColumnType("decimal(20, 5)");

                entity.Property(e => e.RealTotalAmountTax).HasColumnType("decimal(20, 5)");

                entity.Property(e => e.RealTotalAmountTaxPlus).HasColumnType("decimal(20, 5)");
                ...
                entity.Property(e => e.VarianceTotalAmountBeforeTax)
                    .HasColumnType("decimal(21, 5)")
                    .HasComputedColumnSql("([TotalAmountBeforeTax]-[RealTotalAmountBeforeTax])", false);

                entity.Property(e => e.VarianceTotalAmountTax)
                    .HasColumnType("decimal(21, 5)")
                    .HasComputedColumnSql("([TotalAmountTax]-[RealTotalAmountTax])", false);
            ...
            modelBuilder.Entity<OriginAccountingVoucherDetails>(entity =>
            {
                entity.Property(e => e.CalculationUnit).HasMaxLength(50);
                ...
                entity.HasOne(d => d.AccountingVoucher)
                    .WithMany(p => p.OriginAccountingVoucherDetails)
                    .HasForeignKey(d => d.AccountingVoucherId)
                    .HasConstraintName("FK_OriginAccountingVoucher_OriginAccountingVoucherDetails");
            });

            modelBuilder.Entity<OriginAccountingVoucherDetailsSum>(entity =>
            {
                entity.Property(e => e.Amount).HasColumnType("decimal(20, 5)");
                ...
                entity.HasOne(d => d.AccountingVoucher)
                    .WithMany(p => p.OriginAccountingVoucherDetailsSum)
                    .HasForeignKey(d => d.AccountingVoucherId)
                    .HasConstraintName("FK_OriginAccountingVoucherDetailsSum_OriginAccountingVoucher");
            });
            ...
            modelBuilder.Entity<Vendor>(entity =>
            {
                ...
                entity.Property(e => e.LinkAPI).HasMaxLength(250);
                ...
                entity.Property(e => e.PasswordEInvoice).HasMaxLength(250);
                ...
                entity.Property(e => e.UserEInvoice).HasMaxLength(250);
            });
            ...
            modelBuilder.Entity<VendorContact>(entity =>
            {
                ...
                entity.Property(e => e.ContactPhoneNumber).HasMaxLength(250);

                entity.Property(e => e.ContactUser).HasMaxLength(250);
