        ...
        public override async Task<ActionResult<Transportation>> PatchAsync([FromQuery] ODataQueryOptions<Transportation> options, [FromBody] PatchUpdate patch, [FromQuery] bool disableTrigger = false)
        {
            ...
            x.Field != nameof(entity.IsLocked)))
            {
                ...
                if (entity.IsKt)
                {
                    ...
                    || (x.Field == nameof(entity.ClosingDate) && DateTime.Parse(x.Value).Date != entity.ClosingDate.Value.Date)
                    || (x.Field == nameof(entity.StartShip) && DateTime.Parse(x.Value).Date != entity.StartShip.Value.Date)
                    ...
                    || (x.Field == nameof(entity.ShipDate) && DateTime.Parse(x.Value).Date != entity.ShipDate.Value.Date)
                    || (x.Field == nameof(entity.ReturnDate) && DateTime.Parse(x.Value).Date != entity.ReturnDate.Value.Date)
