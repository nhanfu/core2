...
namespace CoreAPI.Services.Sql
{
    public interface ISqlProvider
    {
        ...
        Task<T> ReadDsAs<T>(string query, string connInfo = null, List<WhereParamVM> paramVMs = null) where T : class;
        Task<T[]> ReadDsAsArr<T>(string query, string connInfo = null, List<WhereParamVM> paramVMs = null) where T : class;
