...
(function() {
  ...
  function K(d, l, T, v, $) {
      ...
      v.push([d, l, T, $]);
      return d.addEventListener ? (d.addEventListener(l, T, $),
      T) : d.attachEvent ? (v = function(l) {
          l = l || window.event;
  ...
  function hb(d) {
      if (d._menuButton)
          d.exportEnabled ? (O(d._menuButton, {
              backgroundColor: d.toolbar.itemBackgroundColor,
              color: d.toolbar.fontColor
          }),
          La(d._menuButton),
          ta(d, d._menuButton, "menu")) : xa(d._menuButton);
          ...
          K(d._menuButton, "touchstart", function(d) {
              l = !0
          ...
          K(d._menuButton, "mouseout", function() {
              l || (O(d._menuButton, {
                  backgroundColor: d.toolbar.itemBackgroundColor,
                  color: d.toolbar.fontColor
              }),
      ...
      if (d.exportEnabled && d._dropdownMenu) {
          ...
          for (var p = d._dropdownMenu.childNodes, ba = [d._cultureInfo.printText, d._cultureInfo.saveJPGText, d._cultureInfo.savePNGText], $ = 0; $ < ba.length; $++)
              O(p[$], {
                  backgroundColor: d.toolbar.itemBackgroundColor,
                  color: d.toolbar.fontColor
              }),
          ...
          !d._dropdownMenu && (d.exportEnabled && v) && (l = !1,
          ...
          K(d._dropdownMenu, "blur", function() {
              xa(d._dropdownMenu);
          ...
          K(p, "touchstart", function(d) {
              l = !0
          }, d.allDOMEventHandlers),
          K(p, "mousemove", function() {
              l || (this.style.backgroundColor = d.toolbar.itemBackgroundColorOnHover,
              this.style.color = d.toolbar.fontColorOnHover)
          }, d.allDOMEventHandlers, !0),
          K(p, "mouseout", function() {
  ...
  function Ma(d, l, T, ba) {
      v && bb ? (ba = !p(ba) && ba ? d.getContext("2d", {
          willReadFrequently: !0
      }) : d.getContext("2d"),
      Na = ba.webkitBackingStorePixelRatio || ba.mozBackingStorePixelRatio || ba.msBackingStorePixelRatio || ba.oBackingStorePixelRatio || ba.backingStorePixelRatio || 1,
      ma = Ta / Na,
      d.width = l * ma,
      d.height = T * ma,
      Ta !== Na && (d.style.width = l + "px",
      d.style.height = T + "px",
      ba.scale(ma, ma))) : (d.width = l,
      d.height = T)
  }
  function ib(d) {
      if (!jb) {
          var l = !1
            , p = !1;
          "undefined" === typeof qa.Chart.creditHref ? (d.creditHref = ja("iuuqr;..b`ow`rkr/bnl."),
          d.creditText = ja("B`ow`rKR/bnl")) : (l = d.updateOption("creditText"),
          p = d.updateOption("creditHref"));
          if (d.creditHref && d.creditText) {
              d._creditLink || (d._creditLink = document.createElement("a"),
  ...
  function ta(d, l, p) {
      ...
      l.getAttribute("state") !== p && (l.setAttribute("state", p),
  ...
  function La() {
      for (var d = null, l = 0; l < arguments.length; l++)
          d = arguments[l],
          d.style && (d.style.display = "inline")
  }
  function xa() {
      for (var d = null, l = 0; l < arguments.length; l++)
  ...
  function Ua(d, l, p, v, $) {
      ...
      "undefined" !== typeof v && (d = Math.min(v, d),
      "undefined" !== typeof $ && (d = Math.max($, d)));
  ...
  function Z(d, l, v, ba, $) {
      ...
      d = {};
      this.theme && p(this.parent) && p(l) && p(ba) ? d = p(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[l]) && (null === ba ? d = this.parent.themeOptions[l] : 0 < this.parent.themeOptions[l].length && (ba = Math.min(this.parent.themeOptions[l].length - 1, ba),
  ...
  function Aa(d, l) {
      ...
      if (p(this.options.margin) && d.options.subtitles)
          for (var v = d.options.subtitles, ba = 0; ba < v.length; ba++)
              if ((p(v[ba].horizontalAlign) && "center" === this.horizontalAlign || v[ba].horizontalAlign === this.horizontalAlign) && (p(v[ba].verticalAlign) && "top" === this.verticalAlign || v[ba].verticalAlign === this.verticalAlign) && !v[ba].dockInsidePlotArea === !this.dockInsidePlotArea) {
                  this.margin = 0;
                  break
              }
  ...
  var Ha = !1, wa = {}, v = !!document.createElement("canvas").getContext, qa = {
      Chart: {
          width: 500,
          height: 400,
          zoomEnabled: !1,
      ...
      en: {}
  }, t = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Fa = v ? "Impact, Charcoal, sans-serif" : "Arial", Ba = {
  ...
  (function() {
      wa.fSDec = function(d) {
          for (var l = "", p = 0; p < d.length; p++)
              l += String.fromCharCode(Math.ceil(d.length / 57 / 5) ^ d.charCodeAt(p));
          return l
      }
      ;
      delete qa[wa.fSDec("Bi`su")][wa.fSDec("bsdehuIsdg")];
      wa.pro = {
          sCH: qa[wa.fSDec("Bi`su")][wa.fSDec("bsdehuIsdg")]
      }
  }
  )();
  var gb = function() {
      ...
      return function(A, H, P) {
          ...
          return P = H.replace(d, function(r) {
              ...
              case "TT":
                  return 12 > g ? "AM" : "PM";
              case "K":
                  return O ? "UTC" : (String(A).match(t) || [""]).pop().replace(D, "");
              case "z":
    ...
    , da = function(d, l, p) {
      ...
      for (var N = 0; A && N < A.length; N++)
          ...
          "." === l && 0 > H)
              ...
              if ("%" === l)
                  ...
                  "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (O = !0);
              0 > H ? (P.push(l),
              "#" === l || "0" === l ? U++ : "," === l && I++) : (S.push(l),
              "#" !== l && "0" !== l || K++)
          }
      O && (l = Math.floor(d),
      ...
      for (O = A = N = K = H = 0; 0 < P.length; )
          ...
          "#" === l || "0" === l)
              ...
              A = O,
              O = 0,
              0 < D.length && (p = t + p)) : p = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + p : l + p : (l = 0 > Z ? l.replace("+", "").replace("-", "") : l.replace("-", ""),
      ...
      for (P = !1; 0 < S.length; )
          l = S.shift(),
          "#" === l || "0" === l ? 0 < d.length && 0 !== Number(d.join("")) ? (t += d.shift(),
          P = !0) : "0" === l && (t += "0",
          P = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? t += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? t += l : (l = 0 > Z ? l.replace("+", "").replace("-", "") : l.replace("-", ""),
    ...
    , Pa = function(d) {
      var l = 0
        , p = 0;
      d = d || window.event;
      d.offsetX || 0 === d.offsetX ? (l = d.offsetX,
      p = d.offsetY) : d.layerX || 0 == d.layerX ? (l = d.layerX,
      p = d.layerY) : (l = d.pageX - d.target.offsetLeft,
    ...
    , ja = function(d) {
      for (var p = "", v = 0; v < d.length; v++)
          p += String.fromCharCode(Math.ceil(d.length / 57 / 5) ^ d.charCodeAt(v));
      return p
  }
    , jb = window && (window[ja("mnb`uhno")] && window[ja("mnb`uhno")].href && window[ja("mnb`uhno")].href.indexOf && (-1 !== window[ja("mnb`uhno")].href.indexOf(ja("b`ow`rkr/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gdonqhy/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gheemd")))) && -1 === window[ja("mnb`uhno")].href.indexOf(ja("gheemd"))
    , kb = {
      reset: {
  ...
  Z.prototype.setOptions = function(d, p) {
      if (qa[this._defaultsKey]) {
          var v = qa[this._defaultsKey], t;
          for (t in v)
              "publicProperties" !== t && v.hasOwnProperty(t) && (this[t] = d && t in d ? d[t] : p && t in p ? p[t] : v[t])
      } else
  ...
  Z.prototype.get = function(d) {
      ...
      if (p.hasOwnProperty(d) || p.publicProperties && p.publicProperties.hasOwnProperty(d))
          return this[d];
  ...
  Z.prototype.set = function(d, p, v) {
      ...
      else if (t.hasOwnProperty(d) || t.publicProperties && t.publicProperties.hasOwnProperty(d) && "readWrite" === t.publicProperties[d])
  ...
  Z.prototype.addTo = function(d, p, v, t) {
      ...
      d.splice(v, 0, p),
      t && (this.stockChart || this.chart || this).render()) : window.console && (A.publicProperties && A.publicProperties.hasOwnProperty(d) && "readOnly" === A.publicProperties[d] ? window.console.log('Property "' + d + '" is read-only.') : window.console.log('Property "' + d + "\" doesn't exist. Please check for typo."))
  }
  ;
      ...
      if ("undefined" !== typeof d || this.options._isPlaceholder)
          ...
          this.isOptionsInArray) {
              ...
              var p = this.parent.options[this.optionsName]
                , v = p.length;
              this.options._isPlaceholder || (Da(p),
              v = p.indexOf(this.options));
  ...
  Z.prototype.updateOption = function(d) {
      ...
      var l = qa[this._defaultsKey]
        ...
        , H = this._index;
      this.theme && p(this.parent) && p(A) && p(H) ? v = p(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && this.parent.themeOptions && (this.options.theme && Oa[this.options.theme] ? v = Oa[this.options.theme] : this.parent.themeOptions[A] && (null === H ? v = this.parent.themeOptions[A] : 0 < this.parent.themeOptions[A].length && (v = Math.min(this.parent.themeOptions[A].length - 1, H),
  ...
  Z.prototype.addEventListener = function(d, p, v) {
      d && p && (this._eventListeners[d] = this._eventListeners[d] || [],
      this._eventListeners[d].push({
          context: v || this,
          eventHandler: p
      }))
  }
      ...
      if (0 !== this.fontSize) {
          ...
          for (v = 0; v < this._wrappedText.lines.length; v++) {
              ...
              if ("right" === this.horizontalAlign || "right" === this.textAlign)
                  ...
                  t = (this.width - (this.leftPadding + this.rightPadding)) / 2 - H.width / 2 + this.leftPadding;
  ...
  ka.prototype._getLineWithWidth = function(d, p, v) {
      ...
      v > p && 1 < D.length && (D = D.substr(0, D.length - 1),
      v = this.ctx.measureText(D).width);
      p = !0;
      ...
      if (0 === this.frontSize)
          ...
          for (; 0 < d.length; ) {
              var H = this.maxHeight - (this.topPadding + this.bottomPadding)
                , D = this._getLineWithWidth(d, this.maxWidth - (this.leftPadding + this.rightPadding), !1);
  ...
  Aa.prototype.setLayout = function() {
      if (this.text) {
          var d = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = d.layoutManager.getFreeSpace(), v = l.x1, t = l.y1, A = 0, H = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 40 : 0, I, K;
          ...
          A = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = l.height - 4),
          H = 0.5 * l.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = l.width - 4),
          H = 0.5 * l.height - 4));
          var P;
          p(this.padding) || "number" !== typeof this.padding ? p(this.padding) || "object" !== typeof this.padding || (P = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
          ...
          K = "top") : "bottom" === this.verticalAlign && (t = l.y2 - 2 - P.height + this.fontSize / 2 + 4,
          K = "bottom"),
          "left" === this.horizontalAlign ? v = l.x1 + 2 : "center" === this.horizontalAlign ? v = l.x1 + l.width / 2 - P.width / 2 : "right" === this.horizontalAlign && (v = l.x2 - 2 - P.width - D),
          I = this.horizontalAlign,
          this.width = P.width,
          this.height = P.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (v = l.x1 + 2 + (this.fontSize / 2 + 4),
          t = l.y2 - 2 - (this.maxWidth / 2 - P.width / 2),
          A = -90,
          K = "left",
          this.width = P.height,
          this.height = P.width) : "right" === this.horizontalAlign ? (v = l.x2 - 2 - (this.fontSize / 2 + 4),
          t = l.y1 + 2 + (this.maxWidth / 2 - P.width / 2),
          A = 90,
          K = "right",
          this.width = P.height,
          this.height = P.width) : "center" === this.horizontalAlign && (t = d.y1 + (d.height / 2 - P.height / 2) + this.fontSize / 2 + 4,
  ...
  var Qa = {
      ...
      formatNumber: function(d, p, v) {
          v = v || "en";
          if (Ka[v])
              return da(d, p || "#,##0.##", new Ja(v));
          throw "Unknown Culture Name";
      },
      formatDate: function(d, p, v) {
          v = v || "en";
          if (Ka[v])
              return Ca(d, p || "DD MMM YYYY", new Ja(v));
          throw "Unknown Culture Name";
      }
  };
  ...
  t = Qa.Chart = function() {
      ...
      function l(a, g, c) {
          ...
          g = c && c.height ? c.height : this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height,
          this.width = a,
          this.height = g,
          this.x1 = this.y1 = 0,
          this.x2 = this.width,
          ...
          v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = va(a, g),
          ...
          this.windowResizeHandler = K(window, "resize", function() {
      ...
      function A(a, g, c, b, e, h, r, x, J, k) {
          ...
          a.beginPath();
          J && 0 < x.thickness ? (a.moveTo(b - r.thickness / 2, Math.round((c + e) / 2) - q),
          a.lineTo(g + r.thickness / 2, Math.round((c + e) / 2) - q)) : 0 < x.thickness && (a.moveTo(Math.round((g + b) / 2) - q, c + r.thickness / 2),
          ...
          a.beginPath();
          J && 0 < r.thickness ? (a.moveTo(b - m, c),
          a.lineTo(b - m, e),
          a.moveTo(g + m, c),
          a.lineTo(g + m, e)) : 0 < r.thickness && (a.moveTo(g, c + m),
          a.lineTo(b, c + m),
          a.moveTo(g, e - m),
          a.lineTo(b, e - m));
          a.stroke();
      ...
      function D(a, g, c, b, e, h) {
          ...
          this.isOptionsInArray = !0;
          "axisX" === e ? ("left" === h || "bottom" === h ? (this.optionsName = "axisX",
          p(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}),
          ...
          this.options.scaleBreaks && (this.scaleBreaks = new ia(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,this));
          this.stripLines = [];
      ...
      l.prototype._updateOptions = function() {
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
              ...
              this._resetButton.title = this._cultureInfo.resetText) : (g = !1,
      ...
      l.prototype._initialize = function() {
          ...
          if (this.options.data) {
              ...
              for (c = 0; c < this.data.length; c++) {
                  ...
                  "error" === this.data[c].type && (this.data[c].axisPlacement = this.plotInfo.axisPlacement = g || "normal",
      ...
      l.prototype.setLayout = function() {
          ...
          this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
          this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor) : (xa(this._zoomButton, this._resetButton),
          ...
          for (g = 0; g < this._axes.length; g++)
              if (this._axes[g].scaleBreaks && this._axes[g].scaleBreaks._appliedBreaks.length) {
                  v ? (this._breaksCanvas = va(this.width, this.height, !0),
          ...
          if (this.height) {
              ...
              for (g = 0; g < this.plotInfo.plotTypes.length; g++)
                  for (var h = this.plotInfo.plotTypes[g], r = 0; r < h.plotUnits.length; r++) {
                      ...
                      x.targetCanvas = null;
                      this.animatedRender && (x.targetCanvas = va(this.width, this.height),
                      ...
                      this.animatedRender && (x.targetCanvasCtx.miterLimit = e,
                      J && c.push(J))
                  }
              ...
              if (0 < c.length)
                  ...
                  m._animator.animate(200, m.animationDuration, function(a) {
                      ...
                      for (var e = 0; e < c.length; e++)
                          J = c[e],
                          1 > a && "undefined" !== typeof J.startTimePercent ? a >= J.startTimePercent && J.animationCallback(J.easingFunction(a - J.startTimePercent, 0, 1, 1 - J.startTimePercent), J) : J.animationCallback(J.easingFunction(a, 0, 1, 1), J);
                      ...
                      for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                          for (var e = m.plotInfo.plotTypes[a], f = 0; f < e.plotUnits.length; f++) {
                              var g = e.plotUnits[f];
      ...
      l.prototype.categoriseDataSeries = function() {
          for (var a = "", g = 0; g < this.data.length; g++)
              ...
              a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
                  for (var c = null, b = !1, e = null, h = !1, r = 0; r < this.plotInfo.plotTypes.length; r++)
          ...
          for (g = 0; g < this.plotInfo.plotTypes.length; g++)
              for (c = this.plotInfo.plotTypes[g],
              r = a = 0; r < c.plotUnits.length; r++)
      ...
      l.prototype._processMultiseriesPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, r = 0; r < a.dataSeriesIndexes.length; r++) {
                  var x = this.data[a.dataSeriesIndexes[r]], J = 0, k = !1, m = !1, q;
                  if ("normal" === x.axisPlacement || "xySwapped" === x.axisPlacement)
                      var n = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity
                  ...
                  for (J = 0; J < x.dataPoints.length; J++) {
                      ...
                      x.dataPoints[J].x.getTime ? (h = !0,
                      b = x.dataPoints[J].x.getTime()) : b = x.dataPoints[J].x;
                      e = x.dataPoints[J].y;
                      b < c.min && (c.min = b);
                      b > c.max && (c.max = b);
                      ...
                      if (0 < J) {
                          ...
                          null !== e && null !== x.dataPoints[J - 1].y && (a.axisY.logarithmic ? (d = e / x.dataPoints[J - 1].y,
                          1 > d && (d = 1 / d),
                          g.minDiff > d && 1 !== d && (g.minDiff = d)) : (d = e - x.dataPoints[J - 1].y,
                          0 > d && (d *= -1),
                      ...
                      if (b < n && !k)
                          ...
                          null === e ? c.viewPortMin === b && q < b && (c.viewPortMin = q) : (e < g.viewPortMin && "number" === typeof e && (g.viewPortMin = e),
                          e > g.viewPortMax && "number" === typeof e && (g.viewPortMax = e))
                      }
                  }
      ...
      l.prototype._processStackedPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, r = [], x = [], J = Infinity, k = -Infinity, m = {}, q = 0; q < a.dataSeriesIndexes.length; q++) {
                  var n = this.data[a.dataSeriesIndexes[q]], f = 0, d = !1, w = !1, y;
                  ...
                  for (f = 0; f < n.dataPoints.length; f++) {
                      ...
                      n.dataPoints[f].x.getTime ? (h = !0,
                      b = n.dataPoints[f].x.getTime()) : b = n.dataPoints[f].x;
                      ...
                      if (0 < f) {
                          ...
                          null !== e && null !== n.dataPoints[f - 1].y && (a.axisY.logarithmic ? 0 < e && (u = e / n.dataPoints[f - 1].y,
                          1 > u && (u = 1 / u),
                          g.minDiff > u && 1 !== u && (g.minDiff = u)) : (u = e - n.dataPoints[f - 1].y,
                          0 > u && (u *= -1),
                      ...
                      if (b < s && !d)
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          null === n.dataPoints[f].y ? c.viewPortMin === b && y < b && (c.viewPortMin = y) : (m[b] = (m[b] || 0) + n.dataPoints[f].y,
                          ...
                          0 <= e ? r[b] ? r[b] += e : (r[b] = e,
                          J = Math.min(e, J)) : x[b] ? x[b] += e : (x[b] = e,
                          k = Math.max(e, k)))
                      }
                  }
                  a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (g.dataPointYPositiveSums ? (g.dataPointYPositiveSums.push.apply(g.dataPointYPositiveSums, r),
                  g.dataPointYNegativeSums.push.apply(g.dataPointYPositiveSums, x)) : (g.dataPointYPositiveSums = r,
                  g.dataPointYNegativeSums = x));
                  n.axisX.valueType = n.xValueType = h ? "dateTime" : "number"
              }
              for (f in r)
                  r.hasOwnProperty(f) && !isNaN(f) && (a = r[f],
                  a < g.min && (g.min = Math.min(a, J)),
                  a > g.max && (g.max = a),
                  f < c.viewPortMin || f > c.viewPortMax || (a < g.viewPortMin && (g.viewPortMin = Math.min(a, J)),
                  a > g.viewPortMax && (g.viewPortMax = a)));
              for (f in x)
                  x.hasOwnProperty(f) && !isNaN(f) && (a = x[f],
                  a < g.min && (g.min = a),
                  a > g.max && (g.max = Math.max(a, k)),
                  f < c.viewPortMin || f > c.viewPortMax || (a < g.viewPortMin && (g.viewPortMin = a),
      ...
      l.prototype._processStacked100PlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, r = !1, x = !1, J = {}, k = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                  var q = this.data[a.dataSeriesIndexes[m]], n = 0, f = !1, d = !1, w;
                  if ("normal" === q.axisPlacement || "xySwapped" === q.axisPlacement)
                      var y = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity
                  ...
                  for (n = 0; n < q.dataPoints.length; n++) {
                      ...
                      q.dataPoints[n].x.getTime ? (h = !0,
                      b = q.dataPoints[n].x.getTime()) : b = q.dataPoints[n].x;
                      ...
                      if (0 < n) {
                          ...
                          p(e) || null === q.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < e && (z = e / q.dataPoints[n - 1].y,
                          1 > z && (z = 1 / z),
                          g.minDiff > z && 1 !== z && (g.minDiff = z)) : (z = e - q.dataPoints[n - 1].y,
                          0 > z && (z *= -1),
                      ...
                      if (b < y && !f)
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          null === e ? c.viewPortMin === b && w < b && (c.viewPortMin = w) : (J[b] = (J[b] || 0) + q.dataPoints[n].y,
              ...
              a.axisY.logarithmic ? (g.max = p(g.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(g.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
              g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)) : r && !x ? (g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99),
              g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)) : r && x ? (g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99),
              g.min = p(g.viewPortMin) ? -99 : Math.min(g.viewPortMin, -99)) : !r && x && (g.max = p(g.viewPortMax) ? -1 : Math.max(g.viewPortMax, -1),
      ...
      l.prototype._processMultiYPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h, r, x = !1, J = 0; J < a.dataSeriesIndexes.length; J++) {
                  var k = this.data[a.dataSeriesIndexes[J]], m = 0, q = !1, n = !1, f, d, p;
                  if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                      var y = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity
                        , s = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity;
                  ...
                  for (m = 0; m < k.dataPoints.length; m++) {
                      ...
                      h < g.min && (g.min = h);
                      r > g.max && (g.max = r);
                      0 < m && (a.axisX.logarithmic ? (d = b / k.dataPoints[m - 1].x,
                      1 > d && (d = 1 / d),
                      c.minDiff > d && 1 !== d && (c.minDiff = d)) : (d = b - k.dataPoints[m - 1].x,
                      0 > d && (d *= -1),
                      c.minDiff > d && 0 !== d && (c.minDiff = d)),
                      e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (d = e[0] / k.dataPoints[m - 1].y[0],
                      1 > d && (d = 1 / d),
                      g.minDiff > d && 1 !== d && (g.minDiff = d)) : (d = e[0] - k.dataPoints[m - 1].y[0],
                      0 > d && (d *= -1),
                      g.minDiff > d && 0 !== d && (g.minDiff = d))));
                      if (!(b < y) || q) {
                          if (!q && (q = !0,
                          ...
                          null === e ? c.viewPortMin === b && f < b && (c.viewPortMin = f) : (h < g.viewPortMin && (g.viewPortMin = h),
          ...
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, r = 0; r < a.dataSeriesIndexes.length; r++) {
                  ...
                  if ("normal" === x.axisPlacement || "xySwapped" === x.axisPlacement)
                      var n = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity
                        , f = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity;
                  if (x.dataPoints[d].x && x.dataPoints[d].x.getTime || "dateTime" === x.xValueType)
                      h = !0;
                  for (d = 0; d < x.dataPoints.length; d++)
                      "undefined" !== typeof x.dataPoints[d].isCumulativeSum && !0 === x.dataPoints[d].isCumulativeSum ? (x.dataPointEOs[d].cumulativeSumYStartValue = 0,
                      ...
                      b = 0) : (e = "number" !== typeof x.dataPoints[d].y ? 0 : x.dataPoints[d].y,
                      x.dataPointEOs[d].cumulativeSumYStartValue = 0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum,
                      x.dataPointEOs[d].cumulativeSum = 0 === d ? e : x.dataPointEOs[d - 1].cumulativeSum + e,
                      b += e);
                  for (d = 0; d < x.dataPoints.length; d++)
                      if ("undefined" === typeof x.dataPoints[d].x && (x.dataPoints[d].x = d + (a.axisX.logarithmic ? 1 : 0)),
                      x.dataPoints[d].x.getTime ? (h = !0,
                      b = x.dataPoints[d].x.getTime()) : b = x.dataPoints[d].x,
                      e = x.dataPoints[d].y,
                      b < c.min && (c.min = b),
                      b > c.max && (c.max = b),
                      x.dataPointEOs[d].cumulativeSum < g.min && (g.min = x.dataPointEOs[d].cumulativeSum),
                      x.dataPointEOs[d].cumulativeSum > g.max && (g.max = x.dataPointEOs[d].cumulativeSum),
                      0 < d && (a.axisX.logarithmic ? (q = b / x.dataPoints[d - 1].x,
                      1 > q && (q = 1 / q),
                      c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = b - x.dataPoints[d - 1].x,
                      0 > q && (q *= -1),
                      c.minDiff > q && 0 !== q && (c.minDiff = q)),
                      null !== e && null !== x.dataPoints[d - 1].y && (a.axisY.logarithmic ? (e = x.dataPointEOs[d].cumulativeSum / x.dataPointEOs[d - 1].cumulativeSum,
                      1 > e && (e = 1 / e),
                      g.minDiff > e && 1 !== e && (g.minDiff = e)) : (e = x.dataPointEOs[d].cumulativeSum - x.dataPointEOs[d - 1].cumulativeSum,
                      0 > e && (e *= -1),
                      ...
                      !(b < n) || k) {
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          0 < d && (x.dataPointEOs[d - 1].cumulativeSum < g.viewPortMin && (g.viewPortMin = x.dataPointEOs[d - 1].cumulativeSum),
                          x.dataPointEOs[d - 1].cumulativeSum > g.viewPortMax && (g.viewPortMax = x.dataPointEOs[d - 1].cumulativeSum));
                          x.dataPointEOs[d].cumulativeSum < g.viewPortMin && (g.viewPortMin = x.dataPointEOs[d].cumulativeSum);
                          x.dataPointEOs[d].cumulativeSum > g.viewPortMax && (g.viewPortMax = x.dataPointEOs[d].cumulativeSum)
                      }
                  x.axisX.valueType = x.xValueType = h ? "dateTime" : "number"
              }
      }
      ...
      l.prototype.calculateAutoBreaks = function() {
          ...
          function g(a) {
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                  ...
                  if (b || c)
                      for (var f = a.axisY.dataInfo, g = a.axisX.dataInfo, h, r = g.min, k = g.max, m = f.min, q = f.max, g = g._dataRanges, f = f._dataRanges, n, x = 0, d = 0; d < a.dataSeriesIndexes.length; d++) {
                          var J = e.data[a.dataSeriesIndexes[d]];
                          if (!(4 > J.dataPoints.length))
                              for (x = 0; x < J.dataPoints.length; x++)
                                  if (b && (n = (k + 1 - r) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                  ...
                                  c) {
                                      ...
                                      if ((h = "waterfall" === a.type ? J.dataPointEOs[x].cumulativeSum : J.dataPoints[x].y) && h.length)
                                          for (var l = 0; l < h.length; l++)
                                              n = Math.floor((h[l] - m) / v),
                                              h[l] < f[n].min && (f[n].min = h[l]),
                                              h[l] > f[n].max && (f[n].max = h[l]);
                                      else
                                          p(h) || (n = Math.floor((h - m) / v),
                                          h < f[n].min && (f[n].min = h),
                                          h > f[n].max && (f[n].max = h))
                                  }
                      }
          ...
          function c(a) {
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                  for (var b = a.axisX.dataInfo, c = b.min, f = b.max, g = b._dataRanges, h, r = 0, k = 0; k < a.dataSeriesIndexes.length; k++) {
                      var m = e.data[a.dataSeriesIndexes[k]];
                      if (!(4 > m.dataPoints.length))
                          for (r = 0; r < m.dataPoints.length; r++)
                              h = (f + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
          ...
          if (h) {
              for (r = 0; r < this.plotInfo.plotTypes.length; r++)
                  for (h = this.plotInfo.plotTypes[r],
                  x = 0; x < h.plotUnits.length; x++)
                      b = h.plotUnits[x],
              ...
              for (r = 0; r < this._axes.length; r++)
                  if (this._axes[r].dataInfo._dataRanges) {
                      ...
                      if (this._axes[r].dataInfo.dataPointYPositiveSums) {
                          ...
                          m = k;
                          for (x in n)
                              if (n.hasOwnProperty(x) && !isNaN(x) && (q = n[x],
                              !p(q))) {
                      ...
                      if (this._axes[r].dataInfo.dataPointYNegativeSums) {
                          ...
                          m = k;
                          for (x in n)
                              n.hasOwnProperty(x) && !isNaN(x) && (q = -1 * n[x],
                              p(q) || (f = Math.floor((q - d) / b),
                              q < m[f].min && (m[f].min = q),
                              q > m[f].max && (m[f].max = q)));
                      ...
                      for (x = 0; x < Math.min(h.length, this._axes[r].scaleBreaks.maxNumberOfAutoBreaks); x++)
                          b = a(h[x].start, h[x].end, this._axes[r].logarithmic ? this._axes[r].dataInfo.max / this._axes[r].dataInfo.min : this._axes[r].dataInfo.max - this._axes[r].dataInfo.min, this._axes[r].logarithmic),
                          this._axes[r].scaleBreaks.autoBreaks.push(new ga(this,"autoBreaks",b,x,++this._eventManager.lastObjectId,this._axes[r].scaleBreaks)),
      ...
      l.prototype.getDataPointAtXY = function(a, g, c) {
          ...
          for (c = 0; c < b.length; c++)
              if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                  if (e = na("markerSize", b[c].dataPoint, b[c].dataSeries) || 8,
                  b[c].distance <= e / 2) {
                      g = !0;
                      break
                  }
          ...
          if (a.changedTouches && this.interactivityEnabled) {
              ...
              case "MSPointerUp":
                  var h = this._lastTouchData && this._lastTouchData.time ? new Date - this._lastTouchData.time : 0
                    , g = "touchstart" === this._lastTouchEventType || "MSPointerDown" === this._lastTouchEventType || 300 > h ? ["mouseup", "click"] : ["mouseup"];
                  break;
              default:
                  return
              }
              if (!(c && 1 < c.length)) {
                  ...
                  if (this._lastTouchData.scroll && this.zoomEnabled)
                      ...
                      for (c = 0; c < g.length; c++)
                          ...
                          r.initMouseEvent(e, !0, !0, window, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1, !1, !1, !1, 0, null),
                          b.target.dispatchEvent(r),
                          !p(this._lastTouchData.scroll) && !this._lastTouchData.scroll || !this._lastTouchData.scroll && 250 < h || "click" === e)
      ...
      l.prototype._mouseEventHandler = function(a) {
          function g() {
              l.capturedEventParam && (e = l.capturedEventParam,
              r = e.bounds,
              "mouseup" === b && (l.capturedEventParam = null,
              ...
              e.hasOwnProperty(b) && ("mouseup" !== b || e.chart.overlaidCanvas.releaseCapture ? a.target !== e.chart.overlaidCanvas && v || e[b].call(e.context, c.x, c.y) : a.target !== e.chart.overlaidCanvas && (e.chart.isDrag = !1)))
          }
          ...
          this.interactivityEnabled) {
              ...
              var r;
              Ha && window.console && (window.console.log(b + " --\x3e x: " + c.x + "; y:" + c.y),
                      ...
                      for (h = 0; h < this._events.length; h++)
                          if (this._events[h].hasOwnProperty(b))
                              ...
                              c.x >= r.x1 && c.x <= r.x2 && c.y >= r.y1 && c.y <= r.y2) {
                                  ...
                                  "mousedown" === b && !0 === e.capture ? (l.capturedEventParam = e,
              ...
              if (this.panEnabled || this.zoomEnabled) {
                  if (this.panEnabled)
                      for (e = h = 0; e < this._axes.length; e++)
                          ...
                          r = !0) : c.viewportMaximum > c.maximum && (h = c.viewportMaximum / c.maximum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum / h,
                          c.sessionVariables.newViewportMaximum = c.viewportMaximum / h,
                          r = !0) : c.viewportMinimum < c.minimum ? (h = c.minimum - c.viewportMinimum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum + h,
                          c.sessionVariables.newViewportMaximum = c.viewportMaximum + h,
                          r = !0) : c.viewportMaximum > c.maximum && (h = c.viewportMaximum - c.maximum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum - h,
                      ...
                      2 < Math.abs(c - e) && 2 < Math.abs(b - h) && this._zoomPanToSelectedRegion(c, b, e, h) && (r = !0)
                  }
                  r && (this._ignoreNextEvent = !0,
                  ...
                  r && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (La(this._zoomButton, this._resetButton),
                  ta(this, this._zoomButton, "pan"),
                  ta(this, this._resetButton, "reset")))
              }
          }
          ...
          if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
              ...
              if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                  ...
                  for (var x = 0; x < this.axisX.length; x++)
                      this.axisX[x].crosshair && this.axisX[x].crosshair.enabled && (this.axisX[x].crosshair.hide(),
                      this.axisX[x].crosshair.dispatchEvent("hidden", {
                          chart: this,
                          axis: this.axisX[x].options
                      }, this.axisX[x].crosshair));
                  for (x = 0; x < this.axisX2.length; x++)
                      this.axisX2[x].crosshair && this.axisX2[x].crosshair.enabled && (this.axisX2[x].crosshair.hide(),
                  ...
                  for (x = 0; x < this.axisY.length; x++)
                      this.axisY[x].crosshair && this.axisY[x].crosshair.enabled && (this.axisY[x].crosshair.hide(),
                      this.axisY[x].crosshair.dispatchEvent("hidden", {
                          chart: this,
                          axis: this.axisY[x].options
                      }, this.axisY[x].crosshair));
                  for (x = 0; x < this.axisY2.length; x++)
                      this.axisY2[x].crosshair && this.axisY2[x].crosshair.enabled && (this.axisY2[x].crosshair.hide(),
              ...
              if ((!e || 2 < Math.abs(c) || !h || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                  if (this.panEnabled)
                      ...
                      r._panTimerId = setTimeout(function(b, c, e, f) {
                          return function() {
                              r._zoomPanToSelectedRegion(b, c, e, f, !0) && (r._dispatchRangeEvent("rangeChanging", "pan"),
                              ...
                              r.stockChart && (r.stockChart.navigator && r.stockChart.navigator.enabled) && (r.stockChart._rangeEventParameter.type = "rangeChanged",
                      ...
                      this.validateRegion(b, x, e ? a : this.plotArea.x2 - this.plotArea.x1, h ? g : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
      ...
      l.prototype.validateRegion = function(a, g, c, b, e) {
          e = e || !1;
          for (var h = 0 <= this.zoomType.indexOf("x"), r = 0 <= this.zoomType.indexOf("y"), x = !1, d = [], k = [], m = [], q = 0; q < this._axes.length; q++)
          ...
          for (r = 0; r < k.length; r++) {
              ...
              if (q.scaleBreaks)
                  for (p = 0; !h && p < q.scaleBreaks._appliedBreaks.length; p++)
                      h = q.scaleBreaks._appliedBreaks[p].startValue <= n && q.scaleBreaks._appliedBreaks[p].endValue >= f;
              if (isFinite(q.dataInfo.minDiff))
                  if (p = q.getApparentDifference(n, f, null, !0),
                  !(h || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && p < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && p < 3 * Math.abs(q.dataInfo.minDiff)) || n < q.minimum || f > q.maximum))
                      d.push(q),
                      m.push({
                          val1: n,
                          val2: f
      ...
      l.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              var m = this._indexLabels[a], q = m.chartType.toLowerCase(), n, f, x = na("indexLabelFontColor", m.dataPoint, m.dataSeries), Ra = na("indexLabelFontSize", m.dataPoint, m.dataSeries), d = na("indexLabelFontFamily", m.dataPoint, m.dataSeries), k = na("indexLabelFontStyle", m.dataPoint, m.dataSeries);
              ...
              if (null !== C && "" !== C) {
                  ...
                  if ("stackedarea100" === q) {
                      ...
                      continue;
                  r = x = 2;
                  "horizontal" === l ? (d = w.width,
                  k = w.height) : (k = w.width,
                  d = w.height);
                  if ("normal" === this.plotInfo.axisPlacement) {
                      ...
                      if ("inside" !== u)
                          e = c.y1,
                          h = c.y2,
                          0 < t ? (f = m.point.y + w._lineHeight / 2 - k - x - b,
                          f < e && (f = "auto" === u ? Math.max(m.point.y, e) + w._lineHeight / 2 + x + b : e + w._lineHeight / 2 + x + b,
                          A = f + ("horizontal" === l ? k - w._lineHeight / 2 : 0) > m.point.y,
                          !A || (0 <= q.indexOf("line") || 0 <= q.indexOf("area")) || (f -= b))) : (f = m.point.y + w._lineHeight / 2 + x + b,
                          f > h - k + w._lineHeight / 2 - x && (f = "auto" === u ? Math.min(m.point.y, h) + w._lineHeight / 2 - k - x - b : h + w._lineHeight / 2 - k - x - b,
                          A = f - ("horizontal" === l ? w._lineHeight / 2 : k) < m.point.y,
                          !A || (0 <= q.indexOf("line") || 0 <= q.indexOf("area")) || (f += b)));
                      else {
                          ...
                          if (0 < t) {
                              ...
                              "bubble" === q || "scatter" === q)
                                  ...
                                  0 > f - w._lineHeight / 2 && (f += Math.abs(f - w._lineHeight / 2) <= (m.bounds.y2 - m.bounds.y1) / 2 + x ? Math.abs(f - w._lineHeight / 2) : (m.bounds.y2 - m.bounds.y1) / 2 + x)
                          } else
                              f = Math.min(m.point.y, b),
                              f > h - k - x && ("bubble" === q || "scatter" === q) && (f = Math.min(m.point.y + x, c.y2 - k - x));
                          f = Math.min(f, h)
                      }
                  } else
                      0 <= q.indexOf("line") || 0 <= q.indexOf("area") || 0 <= q.indexOf("scatter") ? (u = "auto",
                      ...
                      ("horizontal" === l ? n : n - w._lineHeight / 2) < h && (n = "auto" === u ? Math.max(m.point.x, h) + ("horizontal" === l ? 0 : w._lineHeight / 2) + x + b : h + ("horizontal" === l ? 0 : w._lineHeight / 2) + r,
                      (A = n + d - ("horizontal" === l ? 0 : w._lineHeight / 2) > m.point.x) && (n -= b))) : (n = m.point.x + ("horizontal" === l ? 0 : w._lineHeight / 2) + r + b,
                      ("horizontal" === l ? n : n - w._lineHeight / 2) > e - d - r - b && (n = "auto" === u ? Math.min(m.point.x, e) - ("horizontal" === l ? d : d - w._lineHeight / 2) - r - b : e - d - r + ("horizontal" === l ? 0 : w._lineHeight / 2),
                      (A = n - ("horizontal" === l ? 0 : w._lineHeight / 2) < m.point.x) && (n += b)))) : (h = Math.max(m.bounds.x1, c.x1),
                      ...
                      n = Math.max(n, h + ("horizontal" === l ? 0 : w._lineHeight / 2 + x)));
                  "vertical" === l && (f += k - w._lineHeight / 2,
                  0 <= "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(q) && (A = 0 < t ? f + ("horizontal" === l ? k - w._lineHeight / 2 : 0) > m.point.y : f - ("horizontal" === l ? w._lineHeight / 2 : k) < m.point.y),
                  "bubble" === q || "scatter" === q) && (n += w._lineHeight / 2 - Ra / 2);
                  w.x = n;
                  w.y = f;
                  w.render(!0);
                  z && ("inside" !== u && (0 > q.indexOf("bar") && ("error" !== q || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A) && (-1 === "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(q) && ("error" !== q || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !A)) && (g.lineWidth = z,
                  g.strokeStyle = s ? s : "gray",
                  g.setLineDash && g.setLineDash(H(y, z)),
                  g.beginPath(),
                  g.moveTo(m.point.x, m.point.y),
                  0 <= q.indexOf("bar") || "error" === q && m.axisSwapped ? g.lineTo(n + (0 < m.direction ? 0 : d) + ("vertical" === l ? -w._lineHeight / 2 : 0), f + ("vertical" === l ? -k / 2 : k / 2 - w._lineHeight / 2)) : 0 <= q.indexOf("column") || "error" === q && !m.axisSwapped ? g.lineTo(n + d / 2 - ("horizontal" === l ? 0 : w._lineHeight / 2), f + ("vertical" === l ? f - k < m.point.y ? 0 : -k : (f - w._lineHeight / 2 < m.point.y ? k : 0) - w._lineHeight / 2)) : 0 <= q.indexOf("waterfall") ? g.lineTo(n + d / 2 - ("horizontal" === l ? 0 : w._lineHeight / 2), "vertical" === l ? 0 < t && f < m.point.y ? f : 0 > t && f - k > m.point.y ? f - k : m.point.y : 0 < t && f + k - w._lineHeight / 2 < m.point.y ? f + k - w._lineHeight / 2 : 0 > t && f - w._lineHeight / 2 > m.point.y ? f - w._lineHeight / 2 : m.point.y) : g.lineTo(n + d / 2 - ("horizontal" === l ? 0 : w._lineHeight / 2), f + ("vertical" === l ? f - k < m.point.y ? 0 : -k : (f + k - w._lineHeight / 2 < m.point.y ? k : 0) - w._lineHeight / 2)),
                  g.stroke())
              }
          }
          g = {
      ...
      l.prototype.renderLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var h = [], r, x = 0; x < a.dataSeriesIndexes.length; x++) {
                  ...
                  var p = k._colorSet
                    , w = p = k.lineColor = k.options.lineColor ? k.options.lineColor : p[0];
                  c.strokeStyle = p;
                  var y = !0, s = 0, l, u;
                  c.beginPath();
                  if (0 < m.length) {
                      for (var E = !1, s = 0; s < m.length; s++)
                          if (l = m[s].x.getTime ? m[s].x.getTime() : m[s].x,
                          !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !E)))
                              if ("number" !== typeof m[s].y)
                                  0 < s && !(k.connectNullData || E || y) && (c.stroke(),
                                  v && b.stroke()),
                                  E = !0;
                              else {
                                  ...
                                  w = m[s].lineColor || p,
                                  c.strokeStyle = w,
                                  c.setLineDash && (m[s].lineDashType ? (q = m[s].lineDashType,
                                  c.setLineDash(H(q, k.lineThickness))) : (q = k.lineDashType,
                                  c.setLineDash(f))));
              ...
              Y.drawMarkers(h);
              v && (g.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
      ...
      l.prototype.renderStepLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var h = [], r, x = 0; x < a.dataSeriesIndexes.length; x++) {
                  ...
                  if (0 < m.length) {
                      for (var E = !1, s = 0; s < m.length; s++)
                          if (z = m[s].getTime ? m[s].x.getTime() : m[s].x,
                          !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !E)))
                              if ("number" !== typeof m[s].y)
                                  0 < s && !(k.connectNullData || E || l) && (c.stroke(),
                                  v && b.stroke()),
                                  E = !0;
                              else {
                                  var C = u;
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var r = [], x = 0; x < a.dataSeriesIndexes.length; x++) {
                  ...
                  if (0 < m.length)
                      for (z = !1,
                      l = 0; l < m.length; l++)
                          if (s = m[l].getTime ? m[l].x.getTime() : m[l].x,
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                              if ("number" !== typeof m[l].y)
                                  0 < l && !z && (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = n,
                                  q = k.nullDataLineDashType) : (g(u),
                                  u = [])),
                                  z = !0;
                              else {
                                  ...
                                  b.setLineDash && (m[l].lineDashType ? (q = m[l].lineDashType,
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                  var n = a.dataSeriesIndexes[m]
                    ...
                    , p = f.dataPoints;
                  if (0 < p.length)
                      for (var l = 5 < q && f.bevelEnabled ? !0 : !1, h = 0; h < p.length; h++)
                          if (p[h].getTime ? d = p[h].x.getTime() : d = p[h].x,
                          !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[h].y) {
                              ...
                              x = s,
                              s = b);
                              b = p[h].color ? p[h].color : f._colorSet[h % f._colorSet.length];
                              ea(c, a.axisX.reversed ? y : r, x, a.axisX.reversed ? r : y, s, b, 0, null, l && (a.axisY.reversed ? 0 > p[h].y : 0 <= p[h].y), (a.axisY.reversed ? 0 <= p[h].y : 0 > p[h].y) && l, !1, !1, f.fillOpacity);
                              b = f.dataPointIds[h];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = U(b);
                              v && ea(this._eventManager.ghostCtx, a.axisX.reversed ? y : r, x, a.axisX.reversed ? r : y, s, b, 0, null, !1, !1, !1, !1);
                              (p[h].indexLabel || f.indexLabel || p[h].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "column",
                                  dataPoint: p[h],
                                  dataSeries: f,
                                  point: {
      ...
      l.prototype.renderStackedColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              p = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                      ...
                      for (k = 0; k < s.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y)
                                  x[b] = s[k].y + (x[b] ? x[b] : 0),
                                  0 < x[b] && (q = a.axisY.convertValueToPixel(x[b]),
                                  ...
                                  r[b] = E;
                              else if (q = a.axisY.convertValueToPixel(s[k].y),
                              0 <= s[k].y) {
                              ...
                              ea(c, m, a.axisY.reversed ? E : q, u, a.axisY.reversed ? q : E, b, 0, null, z && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && z, !1, !1, y.fillOpacity);
                              b = y.dataPointIds[k];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = U(b);
                              v && ea(this._eventManager.ghostCtx, m, q, u, E, b, 0, null, !1, !1, !1, !1);
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                  var l = a.dataSeriesIndexes[f]
                    ...
                    , s = y.dataPoints;
                  if (0 < s.length)
                      for (var z = 5 < p && y.bevelEnabled ? !0 : !1, k = 0; k < s.length; k++)
                          if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x,
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              m = a.axisX.convertValueToPixel(b);
                              ...
                              0 <= s[k].y) {
                                  ...
                                  E = q + C,
                                  q = n + C,
                                  a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.y2 - E) && (E = e.y2),
                                  r[b] = C + (E - q);
                              b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                              ea(c, m, a.axisY.reversed ? E : q, u, a.axisY.reversed ? q : E, b, 0, null, z && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && z, !1, !1, y.fillOpacity);
                              b = y.dataPointIds[k];
                  ...
                  if (0 < p.length) {
                      ...
                      for (h = 0; h < p.length; h++)
                          ...
                          !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[h].y) {
                              ...
                              r = k);
                              b = p[h].color ? p[h].color : f._colorSet[h % f._colorSet.length];
                              ea(c, a.axisY.reversed ? r : s, a.axisX.reversed ? y : x, a.axisY.reversed ? s : r, a.axisX.reversed ? x : y, b, 0, null, l, !1, !1, !1, f.fillOpacity);
                              b = f.dataPointIds[h];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = U(b);
                              v && ea(this._eventManager.ghostCtx, s, a.axisX.reversed ? y : x, r, a.axisX.reversed ? x : y, b, 0, null, !1, !1, !1, !1);
                              (p[h].indexLabel || f.indexLabel || p[h].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "bar",
                                  dataPoint: p[h],
                                  dataSeries: f,
      ...
      l.prototype.renderStackedBar = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              l = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
              this.dataPointMaxWidth && k > f && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f));
              !this.dataPointMaxWidth && (this.dataPointMinWidth && f < k) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
              l < k && (l = k);
              l > f && (l = f);
                  ...
                  if (0 < s.length) {
                      ...
                      for (k = 0; k < s.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              ...
                              else if (m = a.axisY.convertValueToPixel(s[k].y),
                              0 <= s[k].y) {
                                  var C = h[b] ? h[b] : 0;
                                  E = n + C;
                                  m += C;
                                  ...
                                  r[b] = C + (m - E);
                              b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                              ea(c, a.axisY.reversed ? m : E, q, a.axisY.reversed ? E : m, u, b, 0, null, z, !1, !1, !1, y.fillOpacity);
                              b = y.dataPointIds[k];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = U(b);
                              v && ea(this._eventManager.ghostCtx, E, q, m, u, b, 0, null, !1, !1, !1, !1);
                              (s[k].indexLabel || y.indexLabel || s[k].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                  ...
                  if (0 < s.length) {
                      ...
                      for (k = 0; k < s.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              ...
                              else if (m = a.axisY.convertValueToPixel(u),
                              0 <= s[k].y) {
                                  var C = h[b] ? h[b] : 0;
                                  u = n + C;
                                  m += C;
                                  ...
                                  u = m - C,
                                  m = n - C,
                                  a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.x1 - u) && (u = e.x1),
                                  r[b] = C + (m - u);
                              b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                              ea(c, a.axisY.reversed ? m : u, q, a.axisY.reversed ? u : m, E, b, 0, null, z, !1, !1, !1, y.fillOpacity);
                              b = y.dataPointIds[k];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = U(b);
                              v && ea(this._eventManager.ghostCtx, u, q, m, E, b, 0, null, !1, !1, !1, !1);
                              (s[k].indexLabel || y.indexLabel || s[k].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
      ...
      l.prototype.renderArea = function(a) {
          var g, c;
          function b() {
              C && (0 < f.lineThickness && h.stroke(),
              a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? E = u : 0 > a.axisY.viewportMaximum ? E = d.y1 : 0 < a.axisY.viewportMinimum && (E = u),
              h.lineTo(y, E),
              h.lineTo(C.x, E),
              h.closePath(),
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              h.clip();
              v && (r.beginPath(),
              r.rect(k.x1, k.y1, k.width, k.height),
              r.clip());
              for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                  ...
                  if (0 < l.length) {
                      ...
                      for (var fa = !0; w < l.length; w++)
                          if (z = l[w].x.getTime ? l[w].x.getTime() : l[w].x,
                          !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !fa)))
                              if ("number" !== typeof l[w].y)
                                  f.connectNullData || (fa || g) || b(),
                                  fa = !0;
                              else {
                                  y = a.axisX.convertValueToPixel(z);
                                  s = a.axisY.convertValueToPixel(l[w].y);
                                  g || fa ? (!g && f.connectNullData ? (h.setLineDash && (f.options.nullDataLineDashType || c === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (g = y,
                                  c = s,
                                  y = m.x,
                                  s = m.y,
                                  b(),
                                  ...
                                  w < l.length - 1 && (A !== (l[w].lineColor || t) || c !== (l[w].lineDashType || f.lineDashType)) && (b(),
                                  A = l[w].lineColor || t,
                                  h.strokeStyle = A,
                                  h.setLineDash && (l[w].lineDashType ? (c = l[w].lineDashType,
                                  h.setLineDash(H(c, f.lineThickness))) : (c = f.lineDashType,
                                  h.setLineDash(Q))));
                                  ...
                                  0 !== l[w].markerSize && (0 < l[w].markerSize || 0 < f.markerSize) && (z = f.getMarkerProperties(w, y, s, h),
                                  p.push(z),
                                  aa = U(aa),
                                  v && p.push({
                                      x: y,
                                  ...
                                  (l[w].indexLabel || f.indexLabel || l[w].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                      chartType: "area",
                                      dataPoint: l[w],
                                      dataSeries: f,
                                      point: {
      ...
      l.prototype.renderSplineArea = function(a) {
              ...
              if (0 < c.length) {
                  if (0 < m.lineThickness) {
                      ...
                      for (var f = 0; f < c.length - 3; f += 3)
                          ...
                          v && e.bezierCurveTo(c[f + 1].x, c[f + 1].y, c[f + 2].x, c[f + 2].y, c[f + 3].x, c[f + 3].y),
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              b.clip();
              v && (e.beginPath(),
              e.rect(d.x1, d.y1, d.width, d.height),
              e.clip());
              for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  ...
                  r = U(r);
                  e.fillStyle = r;
                  var r = [], n = 0, f, l, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, s = null, z = [];
                  if (0 < q.length) {
                      ...
                      for (l = !1; n < q.length; n++)
                          if (f = q[n].x.getTime ? q[n].x.getTime() : q[n].x,
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !l)))
                              if ("number" !== typeof q[n].y)
                                  0 < n && !l && (m.connectNullData ? b.setLineDash && (0 < z.length && (m.options.nullDataLineDashType || !q[n - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = A,
                                  B = m.nullDataLineDashType) : (g(),
                                  z = [])),
                                  l = !0;
                              else {
                                  ...
                                  n < q.length - 1 && (C !== (q[n].lineColor || E) || B !== (q[n].lineDashType || m.lineDashType)) && (C = q[n].lineColor || E,
                                  z[z.length - 1].newStrokeStyle = C,
                                  b.setLineDash && (q[n].lineDashType ? (B = q[n].lineDashType,
                                  z[z.length - 1].newLineDashArray = H(B, m.lineThickness)) : (B = m.lineDashType,
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                  ...
                  if (0 < l.length) {
                      ...
                      for (; w < l.length; w++)
                          if (z = l[w].x.getTime ? l[w].x.getTime() : l[w].x,
                          !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !c))) {
                              var aa = s;
                              "number" !== typeof l[w].y ? (f.connectNullData || (c || g) || b(),
                              c = !0) : (y = a.axisX.convertValueToPixel(z),
                              s = a.axisY.convertValueToPixel(l[w].y),
                              g || c ? (!g && f.connectNullData ? (h.setLineDash && (f.options.nullDataLineDashType || L === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (g = y,
                              c = s,
                              y = m.x,
                              s = m.y,
                              b(),
                              ...
                              w < l.length - 1 && (A !== (l[w].lineColor || t) || L !== (l[w].lineDashType || f.lineDashType)) && (b(),
                              A = l[w].lineColor || t,
                              h.strokeStyle = A,
                              h.setLineDash && (l[w].lineDashType ? (L = l[w].lineDashType,
                              h.setLineDash(H(L, f.lineThickness))) : (L = f.lineDashType,
                              h.setLineDash(D)))),
                              z = f.dataPointIds[w],
                              ...
                              0 !== l[w].markerSize && (0 < l[w].markerSize || 0 < f.markerSize) && (aa = f.getMarkerProperties(w, y, s, h),
                              p.push(aa),
                              z = U(z),
                              v && p.push({
                                  x: y,
      ...
      l.prototype.renderStackedArea = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = v ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = null, r = [], d = this.plotArea, p = [], k = [], m = [], q = [], n = 0, f, l, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y = this._eventManager.ghostCtx, s, z, u;
              v && y.beginPath();
              b.save();
              v && y.save();
              b.beginPath();
              ...
              b.clip();
              v && (y.beginPath(),
              y.rect(d.x1, d.y1, d.width, d.height),
              y.clip());
                          ...
                          if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                              if ("number" !== typeof ha.y)
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      l = a.axisY.convertValueToPixel(ha.y),
                                      l -= oa;
                                  k.push({
                                      x: f,
                                      y: w - oa
                                  ...
                                  p[h] = w - l;
                                  z || aa ? (!z && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || u === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (z = k.pop(),
                                  u = k[k.length - 1],
                                  g(),
                                  b.moveTo(s.x, s.y),
                                  k.push(u),
                                  ...
                                  n < t.length - 1 && (L !== (t[n].lineColor || A) || u !== (t[n].lineDashType || B.lineDashType)) && (g(),
                                  b.beginPath(),
                                  b.moveTo(f, l),
                                  k.push({
                                      x: f,
                                  ...
                                  L = t[n].lineColor || A,
                                  b.strokeStyle = L,
                                  b.setLineDash && (t[n].lineDashType ? (u = t[n].lineDashType,
                                  b.setLineDash(H(u, B.lineThickness))) : (u = B.lineDashType,
                                  b.setLineDash(D))));
                                  ...
                                  0 <= B.dataPointIndexes[h] && 0 !== ha.markerSize && (0 < ha.markerSize || 0 < B.markerSize) && (oa = B.getMarkerProperties(B.dataPointIndexes[h], f, l, b),
                                  r.push(oa),
                                  h = U(la),
                                  v && r.push({
                                      x: f,
                                  ...
                                  (ha.indexLabel || B.indexLabel || ha.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
      ...
      l.prototype.renderStackedArea100 = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = v ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = null, r = this.plotArea, d = [], p = [], k = [], m = [], q = [], n = 0, f, l, w, y, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u = this._eventManager.ghostCtx;
              b.save();
              v && u.save();
              b.beginPath();
              ...
              b.clip();
              v && (u.beginPath(),
              u.rect(r.x1, r.y1, r.width, r.height),
              u.clip());
              ...
              for (t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < m.length) {
                      ...
                      for (var aa = !0, n = 0; n < m.length; n++) {
                          var h = m[n]
                            , ha = null
                            , ha = 0 <= B.dataPointIndexes[h] ? A[B.dataPointIndexes[h]] : {
                              x: h,
                              y: null
                          };
                          if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                              if ("number" !== typeof ha.y)
                                  B.connectNullData || (aa || y) || g(),
                                  aa = !0;
                              else {
                                  var oa;
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      l = a.axisY.convertValueToPixel(oa),
                                      l -= la;
                                  k.push({
                                      x: f,
                                      y: z - la
                                  ...
                                  p[h] = z - l;
                                  y || aa ? (!y && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (y = k.pop(),
                                  s = k[k.length - 1],
                                  g(),
                                  b.moveTo(w.x, w.y),
                                  k.push(s),
                                  ...
                                  n < A.length - 1 && (L !== (A[n].lineColor || D) || s !== (A[n].lineDashType || B.lineDashType)) && (g(),
                                  b.beginPath(),
                                  b.moveTo(f, l),
                                  k.push({
                                      x: f,
                                  ...
                                  L = A[n].lineColor || D,
                                  b.strokeStyle = L,
                                  b.setLineDash && (A[n].lineDashType ? (s = A[n].lineDashType,
                                  b.setLineDash(H(s, B.lineThickness))) : (s = B.lineDashType,
                                  b.setLineDash(fa))));
                                  if (0 <= B.dataPointIndexes[h]) {
                                  ...
                                  0 <= B.dataPointIndexes[h] && 0 !== ha.markerSize && (0 < ha.markerSize || 0 < B.markerSize) && (la = B.getMarkerProperties(B.dataPointIndexes[h], f, l, b),
                                  d.push(la),
                                  h = U(F),
                                  v && d.push({
                                      x: f,
      ...
      l.prototype.renderBubble = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              this._eventManager.ghostCtx.clip());
              for (var d = -Infinity, p = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                  for (var m = a.dataSeriesIndexes[k], q = this.data[m], n = q.dataPoints, f = 0, e = 0; e < n.length; e++)
                      h = n[e].getTime ? h = n[e].x.getTime() : h = n[e].x,
                      h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[e].z || (f = n[e].z,
                      f > d && (d = f),
                      f < p && (p = f));
              for (var l = 25 * Math.PI, w = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l), k = 0; k < a.dataSeriesIndexes.length; k++)
                  ...
                  0 < n.length)
                      ...
                      e = 0; e < n.length; e++)
                          if (h = n[e].getTime ? h = n[e].x.getTime() : h = n[e].x,
                          !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                              h = a.axisX.convertValueToPixel(h);
                              r = a.axisY.convertValueToPixel(n[e].y);
                              var f = n[e].z
                                , y = 2 * Math.max(Math.sqrt((d === p ? w / 2 : l + (w - l) / (d - p) * (f - p)) / Math.PI) << 0, 1)
              ...
              for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                  ...
                  if (0 < m.length) {
                      ...
                      for (var q = 0, n = 0, e = 0; e < m.length; e++)
                          if (h = m[e].getTime ? h = m[e].x.getTime() : h = m[e].x,
                          !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                              ...
                              c.globalAlpha = 1;
                              Math.sqrt((q - h) * (q - h) + (n - r) * (n - r)) < Math.min(f.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = k.dataPointIds[e],
                              ...
                              q = U(q),
                              v && Y.drawMarker(f.x, f.y, this._eventManager.ghostCtx, f.type, f.size, q, q, f.borderThickness),
      ...
      l.prototype.renderCandlestick = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = null, r = this.plotArea, d = 0, l, k, m, q, n, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, h = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff;
              ...
              for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                  var y = a.dataSeriesIndexes[w]
                    ...
                    , z = s.dataPoints;
                  if (0 < z.length)
                      for (var u = 5 < t && s.bevelEnabled ? !0 : !1, d = 0; d < z.length; d++)
                          if (z[d].getTime ? f = z[d].x.getTime() : f = z[d].x,
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !p(z[d].y) && z[d].y.length && "number" === typeof z[d].y[0] && "number" === typeof z[d].y[1] && "number" === typeof z[d].y[2] && "number" === typeof z[d].y[3]) {
                              ...
                              "candlestick" === s.type ? (c.moveTo(l - A, m),
                              c.lineTo(l - A, Math.min(k, n)),
                              c.stroke(),
                              c.moveTo(l - A, Math.max(k, n)),
                              c.lineTo(l - A, q),
                              c.stroke(),
                              ea(c, E, Math.min(k, n), C, Math.max(k, n), z[d].y[0] <= z[d].y[3] ? s.risingColor : h, B, e, u, u, !1, !1, s.fillOpacity),
                              v && (e = U(D),
                              b.strokeStyle = e,
                              b.moveTo(l - A, m),
                              ...
                              b.lineTo(l - A, q),
                              b.stroke(),
                              ea(b, E, Math.min(k, n), C, Math.max(k, n), e, 0, null, !1, !1, !1, !1))) : "ohlc" === s.type && (c.moveTo(l - A, m),
                              c.lineTo(l - A, q),
                              c.stroke(),
                              c.beginPath(),
                              c.moveTo(l, k),
      ...
      l.prototype.renderBoxAndWhisker = function(a) {
          var g = a.targetCanvasCtx || this.plotArea.ctx
            ...
            , b = this._eventManager.ghostCtx;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = this.plotArea, r = 0, d, l, k, m, q, n, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff;
              isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
              ...
              b.rect(h.x1, h.y1, h.width, h.height),
              b.clip());
              for (var w = !1, w = !!a.axisY.reversed, y = 0; y < a.dataSeriesIndexes.length; y++) {
                  var s = a.dataSeriesIndexes[y]
                    , z = this.data[s]
                    , u = z.dataPoints;
                  if (0 < u.length)
                      for (var E = 5 < t && z.bevelEnabled ? !0 : !1, r = 0; r < u.length; r++)
                          if (u[r].getTime ? f = u[r].x.getTime() : f = u[r].x,
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !p(u[r].y) && u[r].y.length && "number" === typeof u[r].y[0] && "number" === typeof u[r].y[1] && "number" === typeof u[r].y[2] && "number" === typeof u[r].y[3] && "number" === typeof u[r].y[4] && 5 === u[r].y.length) {
                              ...
                              var C = d - t / 2 << 0
                                ...
                                , D = 0 === A % 2 ? 0 : 0.5
                                , L = u[r].whiskerColor ? u[r].whiskerColor : u[r].color ? z.whiskerColor ? z.whiskerColor : u[r].color : z.whiskerColor ? z.whiskerColor : e
                                , Q = "number" === typeof u[r].whiskerThickness ? u[r].whiskerThickness : "number" === typeof z.options.whiskerThickness ? z.whiskerThickness : A
                                , fa = u[r].whiskerDashType ? u[r].whiskerDashType : z.whiskerDashType
                                , aa = p(u[r].whiskerLength) ? p(z.options.whiskerLength) ? t : z.whiskerLength : u[r].whiskerLength
                                , aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t ? t : aa : "string" === typeof aa ? parseInt(aa) * t / 100 > t ? t : parseInt(aa) * t / 100 : t
                                , ha = 1 === Math.round(Q) % 2 ? 0.5 : 0
                                , oa = u[r].stemColor ? u[r].stemColor : u[r].color ? z.stemColor ? z.stemColor : u[r].color : z.stemColor ? z.stemColor : e
                                , la = "number" === typeof u[r].stemThickness ? u[r].stemThickness : "number" === typeof z.options.stemThickness ? z.stemThickness : A
                                , F = 1 === Math.round(la) % 2 ? 0.5 : 0
                                , I = u[r].stemDashType ? u[r].stemDashType : z.stemDashType
                                , K = u[r].lineColor ? u[r].lineColor : u[r].color ? z.lineColor ? z.lineColor : u[r].color : z.lineColor ? z.lineColor : e
                              ...
                              c.beginPath();
                              ea(c, C, Math.min(n, k), B, Math.max(k, n), T, 0, e, w ? E : !1, w ? !1 : E, !1, !1, ua);
                              c.beginPath();
                              ea(c, C, Math.min(m, n), B, Math.max(n, m), O, 0, e, w ? !1 : E, w ? E : !1, !1, !1, ua);
                              c.beginPath();
                              c.lineWidth = A;
                              c.strokeStyle = e;
                              c.rect(C - D, Math.min(k, m) - D, B - C + 2 * D, Math.max(k, m) - Math.min(k, m) + 2 * D);
                              c.stroke();
                              c.save();
                              0 < P && (c.beginPath(),
                              c.globalAlpha = 1,
                              ...
                              b.strokeStyle = e,
                              b.lineWidth = la,
                              0 < la && (b.moveTo(d - D - F, k),
                              b.lineTo(d - D - F, Math.max(l, q)),
                              b.stroke(),
                              b.moveTo(d - D - F, Math.min(l, q)),
                              b.lineTo(d - D - F, m),
                              b.stroke()),
                              ea(b, C, Math.max(k, m), B, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                              0 < Q && (b.beginPath(),
                              b.lineWidth = Q,
      ...
      l.prototype.renderRangeColumn = function(a) {
          var g = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : g;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, h = 0, r, d, l, h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                  var q = a.dataSeriesIndexes[m]
                    ...
                    , f = n.dataPoints;
                  if (0 < f.length)
                      for (var t = 5 < k && n.bevelEnabled ? !0 : !1, h = 0; h < f.length; h++)
                          if (f[h].getTime ? l = f[h].x.getTime() : l = f[h].x,
                          !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !p(f[h].y) && f[h].y.length && "number" === typeof f[h].y[0] && "number" === typeof f[h].y[1]) {
                              b = a.axisX.convertValueToPixel(l);
                              r = a.axisY.convertValueToPixel(f[h].y[0]);
                              d = a.axisY.convertValueToPixel(f[h].y[1]);
                              var w = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + m) * k << 0
                                , y = a.axisX.reversed ? w - k << 0 : w + k << 0
                                , b = f[h].color ? f[h].color : n._colorSet[h % n._colorSet.length];
                              if (r > d) {
                                  var s = r;
                                  r = d;
                                  d = s
                              ...
                              ea(c, a.axisX.reversed ? y : w, r, a.axisX.reversed ? w : y, d, b, 0, b, t, t, !1, !1, n.fillOpacity);
                              b = U(s);
                              v && ea(this._eventManager.ghostCtx, a.axisX.reversed ? y : w, r, a.axisX.reversed ? w : y, d, b, 0, null, !1, !1, !1, !1);
      ...
      l.prototype.renderError = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = !1, r = this.plotArea, d = 0, l, k, m, q, n, f, t, w = a.axisX.dataInfo.minDiff;
              ...
              for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                  var u = a.dataSeriesIndexes[z]
                    , E = this.data[u]
                    , C = E.dataPoints
                    , B = p(E._linkedSeries) ? !1 : E._linkedSeries.type.match(/(bar|column)/ig) && E._linkedSeries.visible ? !0 : !1
                    , D = 0;
                  if (B)
                      for (e = E._linkedSeries.id,
                      s = 0; s < e; s++)
                          !this.data[s].type.match(/(bar|column)/ig) || !this.data[s].visible || this.data[s].type.match(/(stacked)/ig) && D || (this.data[s].type.match(/(range)/ig) && (h = !0),
                          D++);
                  e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                  d = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? y : 1))) << 0 : 0.3 * this.width;
                  h && (d = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? y : 1))) << 0 : 0.03 * this.width);
                  ...
                  if (0 < C.length)
                      for (var H = E._colorSet, d = 0; d < C.length; d++) {
                          var e = E.lineColor = E.options.color ? E.options.color : H[0]
                            , L = {
                              color: C[d].whiskerColor ? C[d].whiskerColor : C[d].color ? E.whiskerColor ? E.whiskerColor : C[d].color : E.whiskerColor ? E.whiskerColor : e,
                          ...
                          var Q = {
                              color: C[d].stemColor ? C[d].stemColor : C[d].color ? E.stemColor ? E.stemColor : C[d].color : E.stemColor ? E.stemColor : e,
                          ...
                          if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !p(C[d].y) && C[d].y.length && "number" === typeof C[d].y[0] && "number" === typeof C[d].y[1]) {
                              ...
                              b ? q = fa : f = fa;
                              b ? (n = a.axisX.reversed ? k + (B ? y : 1) * s / 2 - (B ? D - 1 : 0) * s << 0 : k - (B ? y : 1) * s / 2 + (B ? D - 1 : 0) * s << 0,
                              f = a.axisX.reversed ? n - s << 0 : n + s << 0) : (m = a.axisX.reversed ? l + (B ? y : 1) * s / 2 - (B ? D - 1 : 0) * s << 0 : l - (B ? y : 1) * s / 2 + (B ? D - 1 : 0) * s << 0,
                              ...
                              A(c, Math.min(m, q), Math.min(n, f), Math.max(q, m), Math.max(f, n), e, L, Q, b);
                              v && A(this._eventManager.ghostCtx, m, n, q, f, e, L, Q, b);
                              if (C[d].indexLabel || E.indexLabel || C[d].indexLabelFormatter || E.indexLabelFormatter)
                                  this._indexLabels.push({
                                      chartType: "error",
                                      dataPoint: C[d],
                                      dataSeries: E,
      ...
      l.prototype.renderRangeBar = function(a) {
          var g = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : g;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, h = 0, r, d, l, k, h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                  ...
                  if (0 < t.length) {
                      ...
                      for (h = 0; h < t.length; h++)
                          if (t[h].getTime ? k = t[h].x.getTime() : k = t[h].x,
                          !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !p(t[h].y) && t[h].y.length && "number" === typeof t[h].y[0] && "number" === typeof t[h].y[1]) {
                              ...
                              r = d,
                              d = b);
                              b = t[h].color ? t[h].color : f._colorSet[h % f._colorSet.length];
                              ea(c, r, a.axisX.reversed ? y : l, d, a.axisX.reversed ? l : y, b, 0, null, w, !1, !1, !1, f.fillOpacity);
                              b = f.dataPointIds[h];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = U(b);
                              v && ea(this._eventManager.ghostCtx, r, a.axisX.reversed ? y : l, d, a.axisX.reversed ? l : y, b, 0, null, !1, !1, !1, !1);
                              if (t[h].indexLabel || f.indexLabel || t[h].indexLabelFormatter || f.indexLabelFormatter)
                                  this._indexLabels.push({
                                      chartType: "rangeBar",
                                      dataPoint: t[h],
                                      dataSeries: f,
      ...
      l.prototype.renderRangeArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              b.clip();
              v && (e.beginPath(),
              e.rect(r.x1, r.y1, r.width, r.height),
              e.clip());
              for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                  var p = []
                  ...
                  if (0 < q.length) {
                      ...
                      for (var L = !0; f < q.length; f++)
                          if (s = q[f].x.getTime ? q[f].x.getTime() : q[f].x,
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !L)))
                              if (null !== q[f].y && q[f].y.length && "number" === typeof q[f].y[0] && "number" === typeof q[f].y[1]) {
                                  ...
                                  n || L ? (m.connectNullData && !n ? (b.setLineDash && (m.options.nullDataLineDashType || B === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (p[p.length - 1].newLineDashArray = D,
                                  ...
                                  f < q.length - 1 && (C !== (q[f].lineColor || t) || B !== (q[f].lineDashType || m.lineDashType)) && (g(),
                                  C = q[f].lineColor || t,
                                  p[p.length - 1].newStrokeStyle = C,
                                  b.strokeStyle = C,
                                  b.setLineDash && (q[f].lineDashType ? (B = q[f].lineDashType,
                                  p[p.length - 1].newLineDashArray = H(B, m.lineThickness),
                                  b.setLineDash(p[p.length - 1].newLineDashArray)) : (B = m.lineDashType,
          ...
          function g(a, c) {
              ...
              if (0 < f.length) {
                  ...
                  for (g = 0; g < f.length - 3; g += 3)
                      b.bezierCurveTo(f[g + 1].x, f[g + 1].y, f[g + 2].x, f[g + 2].y, f[g + 3].x, f[g + 3].y),
                      v && e.bezierCurveTo(f[g + 1].x, f[g + 1].y, f[g + 2].x, f[g + 2].y, f[g + 3].x, f[g + 3].y);
                  f = t(y, 2);
                  ...
                  if (0 < k.lineThickness) {
                      ...
                      b.beginPath();
                      b.moveTo(f[0].x, f[0].y);
                      for (var h = g = 0; g < f.length - 3; g += 3,
                      h++) {
              ...
              for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                  ...
                  if (0 < m.length) {
                      ...
                      for (f = !1; q < m.length; q++)
                          if (n = m[q].x.getTime ? m[q].x.getTime() : m[q].x,
                          !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !f)))
                              if (null !== m[q].y && m[q].y.length && "number" === typeof m[q].y[0] && "number" === typeof m[q].y[1]) {
                                  ...
                                  b.setLineDash && (m[q].lineDashType ? (E = m[q].lineDashType,
                                  ...
                                  0 < q && !f && (k.connectNullData ? b.setLineDash && (0 < w.length && (k.options.nullDataLineDashType || !m[q - 1].lineDashType)) && (w[w.length - 1].newLineDashArray = B,
                                  E = k.nullDataLineDashType) : (g(C, z),
                                  w = [],
                                  y = [])),
                                  f = !0;
                      g(C, z);
      ...
      l.prototype.renderWaterfall = function(a) {
          var g = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : g;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx, e = null, h = this.plotArea, r = 0, d, p, k, m, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), r = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
                  ...
                  if (0 < y.length)
                      for (var u = 5 < n && w.bevelEnabled ? !0 : !1, t = !1, C = null, B = null, r = 0; r < y.length; r++)
                          if (y[r].getTime ? m = y[r].x.getTime() : m = y[r].x,
                          "number" !== typeof y[r].y) {
                              if (0 < r && !t && w.connectNullData)
                                  var A = w.options.nullDataLineDashType || !y[r - 1].lineDashType ? w.nullDataLineDashType : y[r - 1].lineDashType;
                              t = !0
                          } else {
                              ...
                              d = a.axisX.reversed ? d + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + f) * n << 0 : d - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + f) * n << 0;
                              ...
                              ea(c, a.axisX.reversed ? D : d, a.axisY.reversed ? k : p, a.axisX.reversed ? d : D, a.axisY.reversed ? p : k, L, 0, L, u, u, !1, !1, w.fillOpacity);
                              e = U(e);
                              v && ea(this._eventManager.ghostCtx, a.axisX.reversed ? D : d, p, a.axisX.reversed ? d : D, k, e, 0, null, !1, !1, !1, !1);
                              var Q, L = d;
                              Q = "undefined" !== typeof y[r].isIntermediateSum && !0 === y[r].isIntermediateSum || "undefined" !== typeof y[r].isCumulativeSum && !0 === y[r].isCumulativeSum ? 0 < y[r].y ? p : k : 0 < y[r].y ? k : p;
                              0 < r && C && (!t || w.connectNullData) && (t && c.setLineDash && c.setLineDash(H(A, s)),
                              c.beginPath(),
                              c.moveTo(C, B - z),
                              c.lineTo(L, Q - z),
                              0 < s && c.stroke(),
      ...
      l.prototype.renderPie = function(a) {
          function g() {
              if (k && m) {
                  ...
                  for (var g = 0; g < m.length; g++) {
                      ...
                      q = h.indexLabelFormatter ? h.indexLabelFormatter(x) : h.indexLabel ? l.replaceKeywordsWithValue(h.indexLabel, h, k, g) : k.indexLabelFormatter ? k.indexLabelFormatter(x) : k.indexLabel ? l.replaceKeywordsWithValue(k.indexLabel, h, k, g) : h.label ? h.label : "";
                      ...
                      d.indexLabelLineColor = h.indexLabelLineColor ? h.indexLabelLineColor : k.options.indexLabelLineColor ? k.options.indexLabelLineColor : h.color ? h.color : k._colorSet[g % k._colorSet.length];
                      ...
                      if (d.midAngle > Math.PI / 2 - s && d.midAngle < Math.PI / 2 + s) {
                          if (0 === a || f[c].midAngle > d.midAngle)
                              c = g;
                          a++
                      } else if (d.midAngle > 3 * Math.PI / 2 - s && d.midAngle < 3 * Math.PI / 2 + s) {
                          if (0 === b || f[e].midAngle > d.midAngle)
                              e = g;
                          b++
                      }
                  ...
                  for (g = 0; g < m.length; g++)
                      d = f[(c + g) % m.length],
                      1 < a && (d.midAngle > Math.PI / 2 - s && d.midAngle < Math.PI / 2 + s) && (h <= a / 2 && !q ? (d.hemisphere = "right",
                      h++) : (d.hemisphere = "left",
                      q = !0));
                  q = !1;
                  for (g = 0; g < m.length; g++)
                      d = f[(e + g) % m.length],
                      1 < b && (d.midAngle > 3 * Math.PI / 2 - s && d.midAngle < 3 * Math.PI / 2 + s) && (r <= b / 2 && !q ? (d.hemisphere = "left",
                      r++) : (d.hemisphere = "right",
                      q = !0))
              }
          }
          function c(a, b) {
              ...
              for (c = 0; c < m.length; c++) {
                  ...
                  if (e > g) {
                      var h = 0.07 * B * Math.cos(f[c].midAngle)
                        ...
                        , r = !1;
                      if (m[c].exploded) {
                          if (1E-9 < Math.abs(f[c].center.x - (u.x + h)) || 1E-9 < Math.abs(f[c].center.y - (u.y + d)))
                              f[c].center.x = u.x + h * a,
                              f[c].center.y = u.y + d * a,
                              r = !0
                      } else if (0 < Math.abs(f[c].center.x - u.x) || 0 < Math.abs(f[c].center.y - u.y))
                      ...
                      qa(l.plotArea.ctx, f[c].center, f[c].radius, m[c].color ? m[c].color : k._colorSet[c % k._colorSet.length], k.type, g, e, k.fillOpacity, f[c].percentInnerRadius)
                  }
              }
              c = l.plotArea.ctx;
              c.save();
              ...
              for (g = g = 0; g < m.length; g++)
                  ...
                  h = 0,
                  h = "left" === e.hemisphere ? "inside" !== k.indexLabelPlacement ? -(e.indexLabelTextBlock.width + q) : -e.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? q : -e.indexLabelTextBlock.width / 2,
                  ...
                  "inside" !== e.indexLabelPlacement && 0 < e.indexLabelLineThickness && (h = e.center.x + B * Math.cos(e.midAngle),
                  d = e.center.y + B * Math.sin(e.midAngle),
                  c.strokeStyle = e.indexLabelLineColor,
                  c.lineWidth = e.indexLabelLineThickness,
                  c.setLineDash && c.setLineDash(H(e.indexLabelLineDashType, e.indexLabelLineThickness)),
                  c.beginPath(),
                  c.moveTo(h, d),
                  c.lineTo(e.indexLabelTextBlock.x, e.indexLabelTextBlock.y),
                  c.lineTo(e.indexLabelTextBlock.x + ("left" === e.hemisphere ? -q : q), e.indexLabelTextBlock.y),
                  c.stroke()),
                  c.lineJoin = "miter");
              c.save()
          }
          ...
          function h(a, c, g) {
              ...
              if (0 <= a && a < m.length) {
                  var n = f[a];
                  if (0 > c && n.indexLabelTextBlock.y < r || 0 < c && n.indexLabelTextBlock.y > k)
                      return 0;
                  var q = 0
                    , p = 0
                    , p = q = q = 0;
                  ...
                  for (k = 1; k < m.length; k++)
                      if (r = (a - k + f.length) % f.length,
                      f[r].hemisphere !== f[a].hemisphere) {
                          r = null;
                          break
                      } else if (f[r].indexLabelText && f[r].hemisphere === f[a].hemisphere && r !== a && (0 > b(f[r], f[a]) || ("right" === f[a].hemisphere ? f[r].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[r].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y)))
                          break;
                      else
                          r = null;
                  p = r;
                  q = e(a);
                  k = r = 0;
                  0 > c ? (k = "right" === n.hemisphere ? p : q,
                  d = c,
                  null !== k && (p = -c,
                  c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (f[k].indexLabelTextBlock.y + f[k].indexLabelTextBlock.height / 2),
                  c - p < v && (r = -p,
                  k = h(k, r, g + 1),
                  +k.toFixed(z) > +r.toFixed(z) && (d = c > v ? -(c - v) : -(p - (k - r)))))) : 0 < c && (k = "right" === n.hemisphere ? q : p,
                  d = c,
                  null !== k && (p = c,
                  c = f[k].indexLabelTextBlock.y - f[k].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2),
                  c - p < v && (r = p,
                  k = h(k, r, g + 1),
                  +k.toFixed(z) < +r.toFixed(z) && (d = c > v ? c - v : p - (r - k)))));
                  d && (g = n.indexLabelTextBlock.y + d,
                  c = 0,
                  c = "right" === n.hemisphere ? u.x + Math.sqrt(Math.pow(w, 2) - Math.pow(g - u.y, 2)) : u.x - Math.sqrt(Math.pow(w, 2) - Math.pow(g - u.y, 2)),
                  n.midAngle > Math.PI / 2 - s && n.midAngle < Math.PI / 2 + s ? (r = (a - 1 + f.length) % f.length,
                  r = f[r],
                  a = f[(a + 1 + f.length) % f.length],
                  "left" === n.hemisphere && "right" === r.hemisphere && c > r.indexLabelTextBlock.x ? c = r.indexLabelTextBlock.x - 15 : "right" === n.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : n.midAngle > 3 * Math.PI / 2 - s && n.midAngle < 3 * Math.PI / 2 + s && (r = (a - 1 + f.length) % f.length,
                  r = f[r],
                  a = f[(a + 1 + f.length) % f.length],
                  "right" === n.hemisphere && "left" === r.hemisphere && c < r.indexLabelTextBlock.x ? c = r.indexLabelTextBlock.x + 15 : "left" === n.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
                  n.indexLabelTextBlock.y = g,
                  n.indexLabelTextBlock.x = c,
                  n.indexLabelAngle = Math.atan2(n.indexLabelTextBlock.y - u.y, n.indexLabelTextBlock.x - u.x))
              }
              return d
          }
          function r() {
              ...
              for (var c = a = 0, g = 0, r = !0, c = 0; 10 > c && (1 > c || 0 < g); c++) {
                  if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && B - g <= A)
                      r = !1;
                  r && (B -= g);
                  g = 0;
                          ...
                          if (null !== x) {
                              ...
                              if (0 > t) {
                                  for (var C = s = 0, E = 0; E < m.length; E++)
                                      E !== a && f[E].hemisphere === d.hemisphere && (f[E].indexLabelTextBlock.y < d.indexLabelTextBlock.y ? s++ : C++);
                                  s = t / (s + C || 1) * C;
                                  var C = -1 * (t - s)
                                    , H = E = 0;
                                  "right" === d.hemisphere ? (E = h(a, s),
                                  C = -1 * (t - E),
                                  H = h(x, C),
                                  +H.toFixed(z) < +C.toFixed(z) && +E.toFixed(z) <= +s.toFixed(z) && h(a, -(C - H))) : (E = h(x, s),
                                  C = -1 * (t - E),
                                  H = h(a, C),
                                  +H.toFixed(z) < +C.toFixed(z) && +E.toFixed(z) <= +s.toFixed(z) && h(x, -(C - H)))
                              }
                          }
                      }
                  } else
                  ...
                  for (a = 0; a < m.length; a++)
                      ...
                      0 !== x.height && 0 !== x.width)
                          x = x = 0,
                          "right" === d.hemisphere ? (x = n.x2 - (d.indexLabelTextBlock.x + d.indexLabelTextBlock.width + q),
                          ...
                          0.3 * d.indexLabelTextBlock.maxWidth > s ? d.indexLabelText = "" : d.indexLabelTextBlock.maxWidth = 0.85 * s,
                          0.3 * d.indexLabelTextBlock.maxWidth < s && (d.indexLabelTextBlock.x -= "right" === d.hemisphere ? 2 : -2)),
                          Math.abs(d.indexLabelTextBlock.y - d.indexLabelTextBlock.height / 2 - u.y) < B || Math.abs(d.indexLabelTextBlock.y + d.indexLabelTextBlock.height / 2 - u.y) < B) && (x /= Math.abs(Math.cos(d.indexLabelAngle)),
                          9 < x && (x *= 0.3),
                          x > g && (g = x)),
                          x = x = 0,
                          0 < d.indexLabelAngle && d.indexLabelAngle < Math.PI ? (x = n.y2 - (d.indexLabelTextBlock.y + d.indexLabelTextBlock.height / 2 + 5),
                          ...
                          0 === h(a, x * s) && h(a, 2 * s)),
                          Math.abs(d.indexLabelTextBlock.x - u.x) < B && (x /= Math.abs(Math.sin(d.indexLabelAngle)),
                          9 < x && (x *= 0.3),
                          x > g && (g = x)));
                  var M = function(a, b, c) {
                      for (var e = [], g = 0; e.push(f[b]),
                              ...
                              if (null !== r) {
                                  ...
                                  if (n = 0 > t) {
                                      ...
                                      var l = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2
                                        , x = p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2
                                  ...
                                  r !== a && (c = r,
                                  g += -t),
                                  0 === d % Math.max(m.length / 10, 3) && (h = !0)) : h = !0;
                                  h && (0 < g && 0 <= a && 0 <= c) && (M(g, a, c),
                                  c = a = -1,
                                  g = 0)
                              }
                          }
          ...
          var l = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var k = this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, q = 10, n = this.plotArea, f = k.dataPointEOs, v = 2, w, y = 1.3, s = 20 / 180 * Math.PI, z = 6, u = {
                  x: (n.x2 + n.x1) / 2,
                  y: (n.y2 + n.y1) / 2
              }, t = 0;
              a = !1;
              for (var C = 0; C < m.length; C++)
                  t += Math.abs(m[C].y),
                  !a && ("undefined" !== typeof m[C].indexLabel && null !== m[C].indexLabel && 0 < m[C].indexLabel.toString().length) && (a = !0),
              ...
              if (0 !== t) {
                  ...
                  var A = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ua(k.innerRadius, B) : 0.7 * B;
                  k.radius = B;
                  ...
                  this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                      ...
                      for (var b = f[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                          ...
                          e > g && qa(l.plotArea.ctx, f[c].center, f[c].radius, r, k.type, g, e, k.fillOpacity, f[c].percentInnerRadius);
                          if (h)
                              break
                      }
                      d();
      ...
      l.prototype.renderFunnel = function(a) {
          ...
          function c() {
              ...
              if (0 === h)
                  return -1;
              for (var r = e[0] = 0, k = 0, m, n, b = b - a, r = !1, d = 0; d < z.length; d++)
                  ...
                  m += 0 == n ? 0 : a / n,
                  k += a / n,
                  r = !0) : (m = (Math.abs(ca) * b - Math.sqrt(n)) / 2,
                  n = b - 2 * m / Math.abs(ca),
                  k += m,
                  k > g && (k -= m,
                  n = c,
          ...
          function b() {
              if (s && z) {
                  for (var a, b, c, g, e, h, d, r, k, m, n, q, l, x, u, w = [], t = [], J = {
                      percent: null,
                      total: null
                  }, C = null, B = 0; B < z.length; B++)
                      u = R[B],
                      u = "undefined" !== typeof u.x5 ? (u.y2 + u.y4) / 2 : (u.y2 + u.y3) / 2,
                      u = f(u).x2 + 1,
                      w[B] = K - u - T;
                  u = 0.5 * T;
                  for (var B = 0, A = z.length - 1; B < z.length || 0 <= A; B++,
                  A--) {
                      ...
                      g = b.indexLabelBackgroundColor || s.indexLabelBackgroundColor || (v ? "transparent" : null);
                      ...
                      "inside" === s.indexLabelPlacement && (w[B] = B !== ea ? s.reversed ? R[B].x2 - R[B].x1 : R[B].x3 - R[B].x4 : R[B].x3 - R[B].x6,
                      20 > w[B] && (w[B] = B !== ea ? s.reversed ? R[B].x3 - R[B].x4 : R[B].x2 - R[B].x1 : R[B].x2 - R[B].x1,
                      w[B] /= 2));
                      l = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth : w[B];
                      if (l > w[B] || 0 > l)
                          l = w[B];
                      ...
                      b = b.indexLabelFormatter ? b.indexLabelFormatter(C) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, s, B) : s.indexLabelFormatter ? s.indexLabelFormatter(C) : s.indexLabel ? y.replaceKeywordsWithValue(s.indexLabel, b, s, B) : b.label ? b.label : "";
                      0 >= m && (m = 0);
          ...
          function e() {
              ...
              e = !1;
              c = 0;
              for (var h, d = K - Z - T / 2, d = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > d ? d : s.indexLabelMaxWidth : d, r = G.length - 1; 0 <= r; r--) {
                  h = z[G[r].id];
                  c = G[r];
                  g = c.textBlock;
              ...
              if (e)
                  for (r = G.length - 1; 0 <= r; r--)
                      ...
                      G[r].textBlock.height = G[r].textBlock.height === 2 * G[r].textBlock.padding ? 0 : G[r].textBlock.height,
                      G[r].textBlock.width = G[r].textBlock.width === 2 * G[r].textBlock.padding ? 0 : G[r].textBlock.width,
                      G[r].textBlock.x = K - d,
                      c = G[r].textBlock.height < G[r].textBlock.maxHeight ? G[r].textBlock.height : G[r].textBlock.maxHeight,
                      ...
                      s.reversed ? (G[r].textBlock.y + G[r].height > V + E && (G[r].textBlock.y = V + E - G[r].height),
                      G[r].textBlock.y < ua - E && (G[r].textBlock.y = ua - E)) : (G[r].textBlock.y < V - E && (G[r].textBlock.y = V - E),
                      G[r].textBlock.y + G[r].height > ua + E && (G[r].textBlock.y = ua + E - G[r].height))
          }
          function h() {
              var a, b, c, g;
              if ("inside" !== s.indexLabelPlacement)
                  for (var e = 0; e < R.length; e++)
                      0 == G[e].textBlock.text.length ? G[e].isDirty = !0 : (a = R[e],
                      c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                      b = s.reversed ? "undefined" !== typeof a.x5 ? c > $ ? f(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < $ ? f(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                      G[e].textBlock.x = b + T,
                      G[e].textBlock.y = c - G[e].height / 2,
                      s.reversed ? (G[e].textBlock.y + G[e].height > V + E && (G[e].textBlock.y = V + E - G[e].height),
                      G[e].textBlock.y < ua - E && (G[e].textBlock.y = ua - E)) : (G[e].textBlock.y < V - E && (G[e].textBlock.y = V - E),
                      G[e].textBlock.y + G[e].height > ua + E && (G[e].textBlock.y = ua + E - G[e].height)));
              else
                  for (e = 0; e < R.length; e++)
                      ...
                      c = G[e].height,
                      g = G[e].width,
                      b >= c ? (b = e != ea ? (a.x4 + a.x3) / 2 - g / 2 : (a.x5 + a.x4) / 2 - g / 2,
                      c = e != ea ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2,
                      G[e].textBlock.x = b,
          ...
          function d() {
              ...
              function b() {
                  ...
                  for (var r, k = 1; k < d; k++) {
                      ...
                      for (var p = G.length - 1; 0 <= p; p--)
                          !G[p].isDirty && (G[p].textBlock.y < g && G[p].textBlock.y + G[p].height > g) && (r = n(p),
                          !(r >= G.length - 1) && G[p].textBlock.y + G[p].height + da > G[r].textBlock.y && (G[p].textBlock.y = G[p].textBlock.y + G[p].height - g > g - G[p].textBlock.y ? g + 1 : g - G[p].height - 1))
                  }
                  for (r = R.length - 1; 0 < r; r--)
                      if (!G[r].isDirty) {
                          ...
                          if (G[r].textBlock.y < G[g].textBlock.y + G[g].height) {
                              e = e || r;
                              f = r;
                              for (d = 0; G[f].textBlock.y < G[g].textBlock.y + G[g].height + da; ) {
              ...
              for (var e, g, f, h, r, k, m = 1, p = 0; p < 2 * m; p++) {
                  for (var s = G.length - 1; 0 <= s && !(0 <= q(s) && q(s),
                  f = G[s],
                  h = f.textBlock,
                  k = (r = n(s) < R.length ? G[n(s)] : null) ? r.textBlock : null,
                  e = +f.height.toFixed(6),
                  g = +h.y.toFixed(6),
                  !f.isDirty && (r && g + e + da > +k.y.toFixed(6)) && (e = h.y + e + da - k.y,
                  g = a(s, -e),
                  g < e && (0 < g && (e -= g),
                  g = a(n(s), e),
                  g != e))); s--)
          ...
          function l(a, b) {
              return (b < R.length ? G[b].textBlock.y : s.reversed ? V + E : ua + E) - (0 > a ? s.reversed ? ua - E : V - E : G[a].textBlock.y + G[a].height + da)
          }
          function t(a, b, c) {
              var e, g, f, d = [], r = E, n = [];
              -1 !== b && (0 <= W.indexOf(b) ? (g = W.indexOf(b),
              W.splice(g, 1)) : (W.push(b),
              ...
              if (0 === W.length)
                  ...
                  g = E * (1 != W.length || 0 != W[0] && W[0] != R.length - 1 ? 2 : 1) / k();
              ...
              a._animator.animate(0, c, function(c) {
                  ...
                  var g = {};
                  g.dataSeries = s;
                  g.dataPoint = s.reversed ? s.dataPoints[z.length - 1 - b] : s.dataPoints[b];
                  g.index = s.reversed ? z.length - 1 - b : b;
                  a.toolTip.highlightObjects([g]);
                  for (g = 0; g < R.length; g++)
                      sa(e, R[g], s.fillOpacity);
                  w(e);
                  L && ("inside" !== s.indexLabelPlacement ? m(e) : h(),
                  A(e));
                  1 <= c && (ia = !1)
          ...
          function m(a) {
              for (var b, c, e, g, h = 0; h < R.length; h++)
                  ...
                  G[h].isDirty || 0 == G[h].lineThickness || (a.strokeStyle = G[h].lineColor,
                  a.lineWidth = G[h].lineThickness,
                  a.setLineDash && a.setLineDash(H(G[h].lineDashType, G[h].lineThickness)),
                  a.beginPath(),
                  a.moveTo(b, c),
                  a.lineTo(e, g),
                  a.stroke())
          ...
          var y = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              for (var s = this.data[a.dataSeriesIndexes[0]], z = s.dataPoints, u = this.plotArea, E = 0.025 * u.width, C = 0.01 * u.width, B = 0, D = u.height - 2 * E, I = Math.min(u.width - 2 * C, 2.8 * u.height), L = !1, Q = 0; Q < z.length; Q++)
                  if (!L && ("undefined" !== typeof z[Q].indexLabel && null !== z[Q].indexLabel && 0 < z[Q].indexLabel.toString().length) && (L = !0),
                  !L && ("undefined" !== typeof z[Q].label && null !== z[Q].label && 0 < z[Q].label.toString().length) && (L = !0),
                  !L && "function" === typeof s.indexLabelFormatter || "function" === typeof z[Q].indexLabelFormatter)
                      L = !0;
              L = L || "undefined" !== typeof s.indexLabel && null !== s.indexLabel && 0 < s.indexLabel.toString().length;
              "inside" !== s.indexLabelPlacement && L || (C = (u.width - 0.75 * I) / 2);
              var Q = u.x1 + C
                , K = u.x2 - C
                , P = u.y1 + E
                , S = u.y2 - E
              ...
              if (0 != s.length && (s.dataPoints && s.visible) && 0 !== z.length) {
                  ...
                  var C = Q + a / 2
                    ...
                    , ua = s.reversed ? P : S;
                  a = [];
                  var C = [], R = [], I = [], Y = P, ea, ca = ($ - V) / (M - X), ga = -ca, Q = "area" === (s.valueRepresents ? s.valueRepresents : "height") ? c() : g();
                  if (-1 !== Q) {
                      if (s.reversed)
                          for (I.push(Y),
                          F = Q.length - 1; 0 < F; F--)
                      ...
                      if (s.reversed)
                          for (F = 0; F < Q.length; F++)
                              I[F] < $ ? (a.push(M),
                              C.push(ba),
                              ea = F) : (a.push((I[F] - V + ca * X) / ca),
                              C.push((I[F] - V + ga * Z) / ga));
                      else
                          for (F = 0; F < Q.length; F++)
                              I[F] < $ ? (a.push((I[F] - V + ca * X) / ca),
                              C.push((I[F] - V + ga * Z) / ga),
                              ea = F) : (a.push(M),
                              C.push(ba));
                      for (F = 0; F < Q.length - 1; F++)
                          Y = s.reversed ? z[z.length - 1 - F].color ? z[z.length - 1 - F].color : s._colorSet[(z.length - 1 - F) % s._colorSet.length] : z[F].color ? z[F].color : s._colorSet[F % s._colorSet.length],
                          F === ea ? R.push({
                              x1: a[F],
                              y1: I[F],
                              x2: C[F],
                      ...
                      for (F = 0; F < z.length; F++)
                          z[F].exploded && (Q = !0,
                          s.reversed ? W.push(z.length - 1 - F) : W.push(F));
                      ...
                      for (F = 0; F < R.length; F++)
                          B = R[F],
                          sa(U, B, s.fillOpacity),
                          ja.push(B.y1);
                      w(U);
                      L && s.visible && ("inside" === s.indexLabelPlacement || y.animationEnabled || m(U),
                      ...
                      !y.animationEnabled && Q ? t(y, -1, 0) : y.animationEnabled && !y.animatedRender && t(y, -1, 0);
                      this.funnelPyramidClickHandler = function(a) {
                          ...
                          0 <= b)) {
                              ...
                              if ("funnel" === s.type || "pyramid" === s.type)
                                  s.reversed ? z[z.length - 1 - a].exploded = z[z.length - 1 - a].exploded ? !1 : !0 : z[a].exploded = z[a].exploded ? !1 : !0;
                              t(y, b, 500)
                          }
                      }
                      ;
      ...
      l.prototype.exportChart = function(a) {
          ...
          if (b && g && c) {
              ...
              if ("undefined" !== typeof Blob && new Blob) {
                  for (var d = b.replace(/^data:[a-z\/]*;base64,/, ""), d = atob(d), p = new ArrayBuffer(d.length), p = new Uint8Array(p), l = 0; l < d.length; l++)
                      p[l] = d.charCodeAt(l);
                  g = new Blob([p.buffer],{
                      type: "image/" + g
                  });
                  try {
                      window.navigator.msSaveBlob(g, c),
                      e = !0
                  } catch (k) {
              ...
              if (!e)
                  try {
                      ...
                      g = window.open(),
                      g.document.write("<img src='" + b + "'></img><div>Please right click on the image and save it to your device</div>"),
                      g.document.close()
                  }
          }
      }
      ...
      l.prototype.replaceKeywordsWithValue = function(a, g, c, b, e) {
          ...
          if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
              ...
              do {
                  ...
                  a = a.replace("#total", da(p, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", h._cultureInfo))
          ...
          return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
              ...
              try {
                  var f = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                  f && 0 < f.length && (d = Ga(f[2]),
                  a = Ga(f[1]))
              } catch (r) {}
              f = null;
              if ("color" === a)
                  return "waterfall" === c.type ? g.color ? g.color : 0 < g.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[d % c._colorSet.length] : g.color ? g.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
      ...
      S.prototype.setLayout = function() {
          var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart
            ...
            , h = 0
            , d = 0
            , l = this.markerMargin = this.chart.options.legend && !p(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
          this.height = 0;
          var v = []
            , k = [];
          if ("top" === this.verticalAlign || "bottom" === this.verticalAlign)
              ...
              h = this.maxWidth = null !== this.maxWidth ? this.maxWidth : g.width,
              d = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * g.height;
          ...
          for (var m = 0; m < this.dataSeries.length; m++) {
              ...
              if (q.dataPoints && q.dataPoints.length)
                  if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                      var n = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ? "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : X.getDefaultLegendMarker(q._linkedSeries.type) : X.getDefaultLegendMarker(q.type) : q.markerType
                        ...
                        , t = q.legendMarkerColor = q.legendMarkerColor ? q.legendMarkerColor : q.markerColor ? q.markerColor : "error" === q.type ? p(q.whiskerColor) ? q._colorSet[0] : q.whiskerColor : q._colorSet[0]
                        , w = q.markerSize || "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type ? 0.75 * this.lineHeight : 0
                        , y = q.legendMarkerBorderColor ? q.legendMarkerBorderColor : q.markerBorderColor
                        , s = q.legendMarkerBorderThickness ? q.legendMarkerBorderThickness : q.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0;
                      ...
                      for (var z = 0; z < q.dataPoints.length; z++) {
                          var u = q.dataPoints[z]
                            , n = u.legendMarkerType ? u.legendMarkerType : q.legendMarkerType ? q.legendMarkerType : X.getDefaultLegendMarker(q.type)
                            , f = u.legendText ? u.legendText : q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                              chart: this.chart,
                              legend: this.options,
                              dataSeries: q,
                              dataPoint: u
                          }) : u.name ? u.name : "DataPoint: " + (z + 1)
                            , t = u.legendMarkerColor ? u.legendMarkerColor : q.legendMarkerColor ? q.legendMarkerColor : u.color ? u.color : q.color ? q.color : q._colorSet[z % q._colorSet.length]
                            , w = 0.75 * this.lineHeight
                            , y = u.legendMarkerBorderColor ? u.legendMarkerBorderColor : q.legendMarkerBorderColor ? q.legendMarkerBorderColor : u.markerBorderColor ? u.markerBorderColor : q.markerBorderColor
                            , s = u.legendMarkerBorderThickness ? u.legendMarkerBorderThickness : q.legendMarkerBorderThickness ? q.legendMarkerBorderThickness : u.markerBorderThickness || q.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0
              ...
              for (m = 0; m < v.length; m++) {
                  ...
                  if (!(0 >= d || "undefined" === typeof d || 0 >= t || "undefined" === typeof t))
                      if ("horizontal" === this.orientation) {
                          ...
                          null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (w + l + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                          if (!q || q.width + Math.round(n.textBlock.width + w + l + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > h)
                              q = {
                                  items: [],
                                  width: 0
                              },
                          ...
                          n.textBlock.y = 0;
                          q.width += Math.round(n.textBlock.width + w + l + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0));
                          q.items.push(n);
                          ...
                          k.push(q)) : (q = k[z],
                          z = (z + 1) % k.length),
                          q && (this.height += n.textBlock.height ? n.textBlock.height : this.lineHeight,
                          n.textBlock.x = q.width,
                          n.textBlock.y = 0,
                          q.width += Math.round(n.textBlock.width + w + l + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)),
                          q.items.push(n),
          ...
          "top" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? g.x1 : "right" === this.horizontalAlign ? g.x2 - this.width : g.x1 + g.width / 2 - this.width / 2,
          b = g.y1) : "center" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? g.x1 : "right" === this.horizontalAlign ? g.x2 - this.width : g.x1 + g.width / 2 - this.width / 2,
          b = g.y1 + g.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (e = "left" === this.horizontalAlign ? g.x1 : "right" === this.horizontalAlign ? g.x2 - this.width : g.x1 + g.width / 2 - this.width / 2,
          b = g.y2 - this.height);
          this.items = v;
      ...
      S.prototype.render = function() {
          ...
          for (var p = 0, l = 0; l < d.length; l++) {
              for (var k = d[l], m = 0, q = 0; q < k.items.length; q++) {
                  var n = k.items[q]
                    , f = n.textBlock.x + a + (0 === q ? 0.2 * h : this.horizontalSpacing)
                    , v = g + p
                    , w = f;
                  ...
                  if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
                      ...
                      this.ctx.beginPath(),
                      this.ctx.moveTo(f - 0.1 * this.lineHeight, v + this.lineHeight / 2),
                      this.ctx.lineTo(f + 0.85 * this.lineHeight, v + this.lineHeight / 2),
                      this.ctx.stroke(),
                  ...
                  Y.drawMarker(f + h / 2, v + this.lineHeight / 2, this.ctx, n.markerType, "error" === n.chartType || "line" === n.chartType || "spline" === n.chartType ? n.markerSize / 2 : n.markerSize, n.markerColor, n.markerBorderColor, n.markerBorderThickness);
                  n.textBlock.x = f + c + h;
                  if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
          ...
          for (; ; ) {
              ...
              if (0 <= h && h < this.dataPoints.length) {
                  ...
                  if (n) {
                      ...
                      case "waterfall":
                      case "error":
                          a >= n.x1 && (a <= n.x2 && g >= n.y1 && g <= n.y2) && (b.push({
                              dataPoint: f,
                              dataPointIndex: h,
                              dataSeries: this,
                              distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y1 - g), Math.abs(n.y2 - g))
                          }),
                          l = !0);
                          break;
                      case "line":
                      ...
                      case "rangeSplineArea":
                          ...
                          y = c ? 20 : w;
                          t = Math.min(Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - g, 2)), Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y2 - g, 2)));
                          t <= y && b.push({
                              dataPoint: f,
                              dataPointIndex: h,
                              dataSeries: this,
                      ...
                      case "doughnut":
                          ...
                          t < n.radius && t > y && (t = Math.atan2(g - w.y, a - w.x),
                          0 > t && (t += 2 * Math.PI),
                          t = Number(((180 * (t / Math.PI) % 360 + 360) % 360).toFixed(12)),
                          w = Number(((180 * (n.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                          y = Number(((180 * (n.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                          0 === y && 1 < n.endAngle && (y = 360),
                          w >= y && (0 !== f.y && !p(f.y)) && (y += 360,
                          t < w && (t += 360)),
                          t > w && t < y && (b.push({
                              dataPoint: f,
                              dataPointIndex: h,
                      ...
                      case "pyramid":
                          t = n.funnelSection;
                          g > t.y1 && g < t.y4 && (t.y6 ? g > t.y6 ? (h = t.x6 + (t.x5 - t.x6) / (t.y5 - t.y6) * (g - t.y6),
                          t = t.x3 + (t.x4 - t.x3) / (t.y4 - t.y3) * (g - t.y3)) : (h = t.x1 + (t.x6 - t.x1) / (t.y6 - t.y1) * (g - t.y1),
                          t = t.x2 + (t.x3 - t.x2) / (t.y3 - t.y2) * (g - t.y2)) : (h = t.x1 + (t.x4 - t.x1) / (t.y4 - t.y1) * (g - t.y1),
                          t = t.x2 + (t.x3 - t.x2) / (t.y3 - t.y2) * (g - t.y2)),
                          a > h && a < t && (b.push({
                              dataPoint: f,
                              dataPointIndex: n.dataPointIndex,
                              dataSeries: this,
                      ...
                      case "boxAndWhisker":
                          if (a >= n.x1 - n.borderThickness / 2 && a <= n.x2 + n.borderThickness / 2 && g >= n.y4 - n.borderThickness / 2 && g <= n.y1 + n.borderThickness / 2 || Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && g >= n.y1 && g <= n.y4)
                              b.push({
                                  ...
                                  dataPointIndex: h,
                                  dataSeries: this,
                                  distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y2 - g), Math.abs(n.y3 - g))
                              }),
                              l = !0;
                          break;
                      case "candlestick":
      ...
      X.prototype.getMarkerProperties = function(a, g, c, b) {
          var e = this.dataPoints
            ...
            , l = p(e[a].markerBorderThickness) ? this.markerBorderThickness ? this.markerBorderThickness : null : e[a].markerBorderThickness
      ...
      D.prototype.createExtraLabelsForLog = function(a) {
          ...
          if (!(5 < a)) {
              ...
              if (Math.log(this.range) / Math.log(g / this.viewportMinimum) < this.noTicks - 1) {
                  for (var c = D.getNiceNumber((g - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < g; b += c)
      ...
      D.prototype.createLabels = function() {
          var a, g, c = 0, b = 0, e, h = 0, d = 0, b = 0, b = this.interval, l = 0, t, k = 0.6 * this.chart.height, m;
          a = !1;
          var q = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : []
            , n = q.length ? p(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0;
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
              ...
              if (this.logarithmic && !this.equidistantInterval)
                  ...
                  b = 0,
                  f = n; b < this.logLabelValues.length; b++)
              ...
              f = n,
              c = this.intervalStartPosition; c < e; Ya(c, b, this.intervalType)) {
                  ...
                  a || (a = this.labelFormatter ? this.labelFormatter({
                      ...
                      value: new Date(m),
                      label: this.labels[m] ? this.labels[m] : null
                  }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : Ca(m, this.valueFormatString, this.chart._cultureInfo),
                  a = new ka(this.ctx,{
                      x: 0,
                      y: 0,
                      maxWidth: h,
          ...
          if ("bottom" === this._position || "top" === this._position)
              l = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * I[this.intervalType + "Duration"] * this.interval,
              ...
              l = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * I[this.intervalType + "Duration"] * this.interval,
          ...
          if (this.labelAutoFit || this.options.labelAutoFit)
              if (p(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360,
              90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)),
              "bottom" === this._position || "top" === this._position)
                          ...
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              if (p(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                  ...
                                  !p(this.options.labelWrap))
                                      this.labelWrap ? p(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, n), m),
                                      this.sessionVariables.labelWrap = this.labelWrap,
                                      g && A.width + g.width >> 0 > 2 * h && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                      this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                      this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > h ? -25 : this.sessionVariables.labelAngle) : p(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                      this.sessionVariables.labelMaxHeight = d,
                                      this.sessionVariables.labelMaxWidth = h,
                                      g && A.width + g.width >> 0 > 2 * h && (this.sessionVariables.labelAngle = -25,
                                      ...
                                      if (p(this.options.labelWrap))
                                          if (!p(this.options.labelMaxWidth))
                                              ...
                                              if (b = A.width + g.width >> 0,
                                              f = this.labelFontSize,
                                              n < h)
                                                  b - 2 * h > q && (q = b - 2 * h,
                                                  b >= 2 * h && b < 2.2 * h ? (this.sessionVariables.labelMaxWidth = h,
                                                  p(this.options.labelFontSize) && 12 < f && (f = Math.floor(12 / 13 * f),
                                                  a.measureText()),
                                                  this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  ...
                                                  this.sessionVariables.labelFontSize = f) : b >= 2.8 * h && b < 3.2 * h ? (this.sessionVariables.labelMaxWidth = Math.max(h, n),
                                                  this.sessionVariables.labelWrap = !0,
                                                  p(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                                  a.measureText()),
                                                  this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * h && b < 3.6 * h ? (this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelMaxWidth = m,
                                                  this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * h && b < 5 * h ? (p(this.options.labelFontSize) && 12 < f && (f = Math.floor(12 / 13 * f),
                                                  a.measureText()),
                                                  this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelMaxWidth = m) : b > 5 * h && (this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelMaxWidth = h,
                                                  ...
                                                  q = 0 === w ? n + this._labels[w + 1].textBlock.measureText().width - 2 * h : n + this._labels[w - 1].textBlock.measureText().width - 2 * h,
                                                  this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelMaxWidth = m;
                                              else if (0 === q)
                                                  for (this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelWrap = !0,
                                                  b = 0; b < this._labels.length; b++)
                                                      ...
                                                      g = this._labels[f].textBlock,
                                                      g.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, n), m),
                                                      g = g.measureText(),
                  ...
                  if (h = p(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth,
                  d = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                  !this.chart.panEnabled && 1 <= this._labels.length) {
                      this.sessionVariables.labelFontSize = this.labelFontSize;
                      this.sessionVariables.labelMaxWidth = h;
                      ...
                      for (c = 0; c < this._labels.length; c++)
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                              Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                              p(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? p(this.options.labelWrap) ? p(this.options.labelWrap) && (p(this.options.labelMaxWidth) ? p(g) || (l = A.height + g.height >> 0,
                              l - 2 * d > n && (n = l - 2 * d,
                              l >= 2 * d && l < 2.4 * d ? (p(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelMaxHeight = d,
                              this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : l >= 2.4 * d && l < 2.8 * d ? (this.sessionVariables.labelMaxHeight = b,
                              this.sessionVariables.labelFontSize = this.labelFontSize,
                              this.sessionVariables.labelWrap = !0) : l >= 2.8 * d && l < 3.2 * d ? (this.sessionVariables.labelMaxHeight = d,
                              this.sessionVariables.labelWrap = !0,
                              p(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                              ...
                              this.sessionVariables.labelWrap = !0,
                              this.sessionVariables.labelFontSize = this.labelFontSize) : l > 3.6 * d && l < 10 * d ? (p(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelFontSize = p(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                              this.sessionVariables.labelMaxWidth = h,
                              this.sessionVariables.labelMaxHeight = d,
                              ...
                              p(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? d : b,
                              this.sessionVariables.labelWrap = this.labelWrap,
          ...
          for (c = 0; c < this.stripLines.length; c++) {
              ...
              if ("outside" === h.labelPlacement) {
                  ...
                  y = p(h.options.labelWrap) || h.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
              ...
              if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                  for (g = 0; g < this._labels.length; g++) {
                      var b = this._labels[g].textBlock
                        , e = b.measureText()
                        , h = 0
                        , h = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                      a < h && (this.labelEffectiveWidth = a = h);
                      this._labels[g].effectiveWidth = h
                  }
              for (g = 0; g < this._stripLineLabels.length; g++)
                  "outside" === this._stripLineLabels[g].stripLine.labelPlacement && (this._stripLineLabels[g].stripLine.value >= this.viewportMinimum && this._stripLineLabels[g].stripLine.value <= this.viewportMaximum) && (b = this._stripLineLabels[g].textBlock,
                  e = b.measureText(),
                  h = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                  "inside" === this.tickPlacement && (h += this.tickLength),
                  "inside" === this.labelPlacement && (a += 0 < this._index ? h : 0),
                  a < h && (a = h),
                  this.stripLineLabelEffectiveWidth = this._stripLineLabels[g].effectiveWidth = h)
          }
          ...
          if ("bottom" === this._position || "top" === this._position) {
              ...
              if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                  for (c = 0; c < this._labels.length; c++) {
                      ...
                      var e = g.measureText()
                        , h = 0
                        , h = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - g.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                      a < h && (this.labelEffectiveHeight = a = h);
                      this._labels[c].effectiveHeight = h
                  }
              for (c = 0; c < this._stripLineLabels.length; c++)
                  "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum && this._stripLineLabels[c].stripLine.value <= this.viewportMaximum) && (g = this._stripLineLabels[c].textBlock,
                  e = g.measureText(),
                  h = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - g.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                  "inside" === this.tickPlacement && (h += this.tickLength),
                  "inside" === this.labelPlacement && (a += 0 < this._index ? h : 0),
                  a < h && (a = h),
                  this.stripLineLabelEffectiveHeight = this._stripLineLabels[c].effectiveHeight = h)
          }
      ...
      D.setLayout = function(a, g, c, b, e, h) {
          var d, l, t, k, m = a[0] ? a[0].chart : g[0].chart, q = m.isNavigator ? 0 : 10, n = m._axes;
          if (a && 0 < a.length)
          ...
          for (f = 0; f < n.length; f++)
              if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length)
                  for (var v = n[f].scaleBreaks._appliedBreaks, w = 0; w < v.length && !(v[w].startValue > n[f].viewportMaximum); w++)
                      v[w].endValue < n[f].viewportMinimum || (p(n[f].scaleBreaks.firstBreakIndex) && (n[f].scaleBreaks.firstBreakIndex = w),
                      v[w].startValue >= n[f].viewPortMinimum && (n[f].scaleBreaks.lastBreakIndex = w));
          for (var y = w = 0, s = 0, z = 0, u = 0, A = 0, C = 0, B, D, H = l = 0, I, Q, K, v = I = Q = K = !1, f = 0; f < n.length; f++)
          ...
          for (f = 0; f < n.length; f++)
              if (n[f].title)
                  ...
                  default:
                      ...
                      n[f]._titleTextBlock.maxHeight = n[f].titleWrap ? 0.8 * h.height : 1.5 * n[f].titleFontSize,
          ...
          if ("normal" === e) {
              for (var z = [], u = [], A = [], C = [], N = [], P = [], O = [], S = []; 4 > w; ) {
                  ...
                  if (c && 0 < c.length)
                      for (A = [],
                      f = R = 0; f < c.length; f++)
                          A.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateWidth() : 0)),
                          R += A[f],
                  ...
                  t = Math.round(h.x2 - $ - Z > m.width - q ? m.width - q : h.x2 - $ - Z);
                  if (a && 0 < a.length)
                      for (z = [],
                      f = W = 0; f < a.length; f++)
                          ...
                          z.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateHeight() : 0)),
                          W += z[f],
                  ...
                  if (g && 0 < g.length)
                      ...
                      f = Y = 0; f < g.length; f++)
                          ...
                          u.push(Math.ceil(g[f] ? g[f].createLabelsAndCalculateHeight() : 0)),
                          Y += u[f],
                  ...
                  if (a && 0 < a.length)
                      for (f = 0; f < a.length; f++)
                          a[f] && (a[f].lineCoordinates.x1 = d,
                          t = Math.round(h.x2 - $ - Z > m.width - q ? m.width - q : h.x2 - $ - Z),
                          a[f]._labels && 1 < a[f]._labels.length && (l = k = 0,
                          k = a[f]._labels[1],
                          ...
                          !a[f] || (!a[f].labelAutoFit || p(B) || p(D) || m.isNavigator || m.stockChart) || (l = 0,
                          0 < a[f].labelAngle ? D + s > t && (l += 0 < a[f].labelAngle ? D + s - t - $ : 0) : 0 > a[f].labelAngle ? B - y < d && B - y < a[f].viewportMinimum && (H = d - (M + a[f].tickLength + A + B - y + a[f].labelFontSize / 2)) : 0 === a[f].labelAngle && (D + s > t && (l = D + s / 2 - t - $),
                          B - y < d && B - y < a[f].viewportMinimum && (H = d - M - a[f].tickLength - A - B + y / 2)),
                          a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < l ? t -= l : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 > a[f].labelAngle && 0 < H ? d += H : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < H && (d += H),
                          0 < l && (t -= l))),
                          m.panEnabled ? W = p(m.sessionVariables.axisX.height) || m.stockChart ? m.sessionVariables.axisX.height = W : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = W,
                  ...
                  if (g && 0 < g.length)
                      for (f = 0; f < g.length; f++)
                          ...
                          g[f].lineCoordinates.x2 = Math.round(h.x2 - $ - Z > m.width - q ? m.width - q : h.x2 - $ - Z),
                          g[f].lineCoordinates.width = Math.abs(t - d),
                          g[f]._labels && 1 < g[f]._labels.length && (k = g[f]._labels[1],
                          l = "dateTime" === g[f].valueType ? g[f]._labels[g[f]._labels.length - 2] : g[f]._labels[g[f]._labels.length - 1],
                          y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)),
                          s = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))),
                          m.panEnabled ? Y = p(m.sessionVariables.axisX2.height) || m.stockChart ? m.sessionVariables.axisX2.height = Y : m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Y,
                          l = Math.round(h.y1),
                          k = g[f].lineCoordinates.y1 = l + Y + X - U,
                          g[f].lineCoordinates.y2 = l,
                          "inside" === g[f].labelPlacement && 0 < f && (g[f].lineCoordinates.y1 = g[f - 1].lineCoordinates.y1 - U - (g[f].labelEffectiveHeight || 0)),
                          "inside" === g[f].tickPlacement && 0 < f && (g[f].lineCoordinates.y1 -= g[f].tickLength),
                          g[f].bounds = {
                              x1: d,
                              y1: l + (Y + X - u[f] - U),
                              x2: t,
                  ...
                  if (c && 0 < c.length)
                      for (f = 0; f < c.length; f++)
                          ...
                          c[f] && (d = Math.round(a[0] ? a[0].lineCoordinates.x1 : g[0].lineCoordinates.x1),
                          M = c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[c[f]._labels.length - 1].textBlock.height / 2 : q,
                          l = Math.round(h.y1 + Y + X < Math.max(M, q) ? Math.max(M, q) : h.y1 + Y + X),
                          t = Math.round(a[0] ? a[0].lineCoordinates.x1 : g[0].lineCoordinates.x1),
                          M = 0 < a.length ? 0 : c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[0].textBlock.height / 2 : q,
                          ...
                          "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.x1 = c[f - 1].lineCoordinates.x1 - T - (c[f].labelEffectiveWidth || 0),
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          b[f] && (d = Math.round(a[0] ? a[0].lineCoordinates.x2 : g[0].lineCoordinates.x2),
                          t = Math.round(d),
                          ...
                          "inside" === b[f].labelPlacement && 0 < f && (b[f].lineCoordinates.x1 = b[f - 1].lineCoordinates.x2 + V + (b[f].labelEffectiveWidth || 0),
                  ...
                  if (a && 0 < a.length)
                      for (f = 0; f < a.length; f++)
                          ...
                          D = a[f].logarithmic ? (1 < d ? Math.log(d) / a[f].conversionParameters.lnLogarithmBase * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1 : (0 < d ? d * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1));
                  if (g && 0 < g.length)
                      for (f = 0; f < g.length; f++)
                          g[f].calculateValueToPixelConversionParameters(),
                          g[f].calculateBreaksSizeInValues(),
                          g[f]._labels && 1 < g[f]._labels.length && (B = (g[f].logarithmic ? Math.log(g[f]._labels[1].position / g[f].viewportMinimum) / g[f].conversionParameters.lnLogarithmBase : g[f]._labels[1].position - g[f].viewportMinimum) * Math.abs(g[f].conversionParameters.pixelPerUnit) + g[f].lineCoordinates.x1,
                          d = g[f]._labels[g[f]._labels.length - ("dateTime" === g[f].valueType ? 2 : 1)].position,
                          d = g[f].getApparentDifference(g[f].viewportMinimum, d),
                          D = g[f].logarithmic ? (1 < d ? Math.log(d) / g[f].conversionParameters.lnLogarithmBase * Math.abs(g[f].conversionParameters.pixelPerUnit) : 0) + g[f].lineCoordinates.x1 : (0 < d ? d * Math.abs(g[f].conversionParameters.pixelPerUnit) : 0) + g[f].lineCoordinates.x1);
                  for (f = 0; f < n.length; f++)
              ...
              for (P = []; 4 > w; ) {
                  ...
                  if (g && 0 < g.length)
                      for (y = [],
                      f = W = 0; f < g.length; f++)
                          y.push(Math.ceil(g[f] ? g[f].createLabelsAndCalculateWidth() : 0)),
                          W += y[f],
                          X += g[f] ? g[f].margin : 0;
                  else
                  ...
                  if (c && 0 < c.length)
                      for (f = 0; f < c.length; f++)
                          ...
                          t = Math.round(h.x2 - W - X > m.width - 10 ? m.width - 10 : h.x2 - W - X),
                          c[f].labelAutoFit && !p(z) && (0 < !a.length && (d = 0 > c[f].labelAngle ? Math.max(d, z) : 0 === c[f].labelAngle ? Math.max(d, z / 2) : d),
                          0 < !g.length && (t = 0 < c[f].labelAngle ? t - u / 2 : 0 === c[f].labelAngle ? t - u / 2 : t)),
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          b[f].lineCoordinates = {},
                          d = Math.round(h.x1 + V + e),
                          t = Math.round(h.x2 - W - X > b[f].chart.width - 10 ? b[f].chart.width - 10 : h.x2 - W - X),
                          b[f] && b[f].labelAutoFit && !p(A) && (0 < !a.length && (d = 0 < b[f].labelAngle ? Math.max(d, A) : 0 === b[f].labelAngle ? Math.max(d, A / 2) : d),
                          0 < !g.length && (t -= C / 2)),
                  ...
                  if (c && 0 < c.length)
                      for (q = [],
                      f = T = 0; f < c.length; f++)
                          q.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)),
                          T += q[f] + c[f].margin,
                          M += c[f].margin;
                  else
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          ...
                          A = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)),
                  ...
                  if (c && 0 < c.length)
                      for (f = c.length - 1; 0 <= f; f--)
                          l = Math.round(h.y2),
                          k = Math.round(h.y2 > c[f].chart.height ? c[f].chart.height : h.y2),
                          c[f].lineCoordinates.y1 = l - (q[f] + c[f].margin + Y),
                          c[f].lineCoordinates.y2 = l - (q[f] + c[f].margin + Y),
                          "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.y1 = c[f].lineCoordinates.y1 + q[f] - (c[f]._titleTextBlock ? c[f]._titleTextBlock.height : 0) - c[f].tickLength - (c[f].stripLineLabelEffectiveHeight || 0) - 5,
                      ...
                      for (f = 0; f < a.length; f++) {
                          ...
                          if (b && 0 < b.length)
                              for (M = 0; M < b.length; M++)
                                  b[M] && b[M].labelAutoFit && (t = b[M].lineCoordinates.x1,
                                  d = t - V);
                          a[f].lineCoordinates = {
                              x1: t - O,
                              y1: l,
                          ...
                          "inside" === a[f].labelPlacement && 0 < f && (a[f].lineCoordinates.x1 = a[f].lineCoordinates.x1 - (H[f] - (a[f]._titleTextBlock ? a[f]._titleTextBlock.height : 0)) + a[f].tickLength + (a[f].stripLineLabelEffectiveWidth || 0),
                  ...
                  if (g && 0 < g.length)
                      for (f = 0; f < g.length; f++) {
                          ...
                          if (c && 0 < c.length)
                              for (M = 0; M < c.length; M++)
                                  c[M] && c[M].labelAutoFit && (t = 0 > c[M].labelAngle ? Math.max(t, z) : 0 === c[M].labelAngle ? Math.max(t, z / 2) : t,
                                  d = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? t - W : d);
                          if (b && 0 < b.length)
                              for (M = 0; M < b.length; M++)
                                  b[M] && b[M].labelAutoFit && (t = b[M].lineCoordinates.x2,
                                  d = t - W);
                          g[f].lineCoordinates = {
                              x1: t + S,
                              y1: l,
                          ...
                          "inside" === g[f].labelPlacement && 0 < f && (g[f].lineCoordinates.x1 = g[f].lineCoordinates.x1 + (y[f] - (g[f]._titleTextBlock ? g[f]._titleTextBlock.height : 0) - 2) - g[f].tickLength - (g[f].stripLineLabelEffectiveWidth || 0),
                          g[f].lineCoordinates.x2 = g[f].lineCoordinates.x1 + g[f].lineThickness / 2);
                          "inside" === g[f].tickPlacement && 0 < f && (g[f].lineCoordinates.x1 += g[f].tickLength,
                          g[f].lineCoordinates.x2 = g[f].lineCoordinates.x1 + g[f].lineThickness / 2);
                          g[f].bounds = {
      ...
      D.prototype.calculateBreaksSizeInValues = function() {
          for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, g = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !p(this.scaleBreaks.options.spacing), e, h = 0; h < g.length; h++)
              ...
              g[h].spacing = Ua(g[h].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0,
              g[h].size = 0 > g[h].spacing ? 0 : Math.abs(g[h].spacing / c),
              this.logarithmic && (g[h].size = Math.pow(this.logarithmBase, g[h].size))
      }
      ;
      D.prototype.calculateBreaksInPixels = function() {
          if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
              ...
              for (var g = 0; g < a.length && !(a[g].startValue > this.conversionParameters.maximum); g++)
                  a[g].endValue < this.conversionParameters.minimum || (p(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = g),
      ...
      D.prototype.renderLabelsTicksAndTitle = function() {
                  ...
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, d, l = this.viewportMaximum, p = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                          ...
                          if (q.position < this.viewportMinimum)
                              break;
                          q.position > this.viewportMaximum || !(k === this._labels.length - 1 || d < Math.log(l / q.position) * p / e) || (c.push(q),
                          l = q.position,
                          d = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                      }
                      this._labels = c
                  } else {
                      for (k = 0; k < this._labels.length; k++)
                          q = this._labels[k],
                          q.position < this.viewportMinimum || (d = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                          c += d);
              ...
              if ("left" === this._position || "right" === this._position)
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], m, l = this.viewportMaximum, p = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                          ...
                          l = q.position,
                          m = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                      }
                      this._labels = c
                  } else {
                      for (k = 0; k < this._labels.length; k++)
                          q = this._labels[k],
                          q.position < this.viewportMinimum || (m = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                          b += m);
          ...
          if ("bottom" === this._position) {
              for (k = 0; k < this._labels.length; k++)
                  q = this._labels[k],
                  q.position < this.viewportMinimum || q.position > this.viewportMaximum || (n = this.getPixelCoordinatesOnAxis(q.position),
                  this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness,
                  this.ctx.strokeStyle = this.tickColor,
                  b = 1 === this.ctx.lineWidth % 2 ? (n.x << 0) + 0.5 : n.x << 0,
                  this.ctx.beginPath(),
                  this.ctx.moveTo(b, n.y << 0),
                  this.ctx.lineTo(b, n.y + this.tickLength << 0),
                  this.ctx.stroke()),
                  g && 0 !== h++ % 2 && this.labelAutoFit || (0 === q.textBlock.angle ? (n.x -= q.textBlock.width / 2,
              ...
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      if (q = a._labels[k],
                      !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (n = a.getPixelCoordinatesOnAxis(q.position),
                      a.tickThickness)) {
              ...
              for (k = 0; k < this._labels.length; k++)
                  ...
                  this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness,
                  this.ctx.strokeStyle = this.tickColor,
                  b = 1 === this.ctx.lineWidth % 2 ? (n.y << 0) + 0.5 : n.y << 0,
                  this.ctx.beginPath(),
                  this.ctx.moveTo(n.x << 0, b),
                  this.ctx.lineTo(n.x - this.tickLength << 0, b),
                  this.ctx.stroke()),
                  g && 0 !== h++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (q.textBlock.y = n.y,
          ...
          if ("inside" === this.labelPlacement)
              this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      q = a._labels[k],
                      q.position < a.viewportMinimum || (q.position > a.viewportMaximum || g && 0 !== h++ % 2 && a.labelAutoFit) || (a.ctx.save(),
                      a.ctx.beginPath(),
              ...
              for (k = 0; k < this._labels.length; k++)
                  q = this._labels[k],
                  q.position < this.viewportMinimum || (q.position > this.viewportMaximum || g && 0 !== h++ % 2 && this.labelAutoFit) || q.textBlock.render(!0)
      }
      ;
      D.prototype.renderInterlacedColors = function() {
          ...
          if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
              ...
              e = 0; e < this._labels.length; e++)
                  g ? (g = this.getPixelCoordinatesOnAxis(this._labels[e].position),
                  ...
                  a.fillRect(Math.min(c.x, g.x), b.y1, Math.abs(c.x - g.x), Math.abs(b.y1 - b.y2)),
                  g = !1) : g = !0;
          else if (("left" === this._position || "right" === this._position) && this.interlacedColor)
              for (a.fillStyle = this.interlacedColor,
              e = 0; e < this._labels.length; e++)
                  g ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position),
                  g = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position),
                  a.fillRect(b.x1, Math.min(c.y, g.y), Math.abs(b.x1 - b.x2), Math.abs(g.y - c.y)),
                  g = !1) : g = !0;
          a.beginPath()
      }
      ;
      D.prototype.renderStripLinesOfThicknessType = function(a) {
          if (this.stripLines && 0 < this.stripLines.length && a) {
              var g = this, c, b, e = 0, h = 0, d = !1;
              b = !1;
              for (var l = [], t = [], k = !1, e = 0; e < this.stripLines.length; e++) {
                  ...
                  !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range)))
                      ...
                      "outside" === c.stripLine.labelPlacement) {
                          ...
                          if ("bottom" === this._position) {
                              ...
                              "top" === this._position ? (q = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                              this.ctx.beginPath(),
                              this.ctx.moveTo(q, b.y << 0),
                              this.ctx.lineTo(q, b.y - this.tickLength << 0),
                              this.ctx.stroke(),
                              ...
                              b.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : "left" === this._position ? (q = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0,
                              this.ctx.beginPath(),
                          ...
                          m._thicknessType === a && (c.textBlock.angle = -90,
                          ...
                          b.x - c.textBlock.height - m.thickness / 2 > this.chart.plotArea.x1 ? p(m.startValue) ? b.x -= c.textBlock.height - c.textBlock.fontSize / 2 + m.thickness / 2 : b.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 : (c.textBlock.angle = 90,
              ...
              if (!k) {
                  ...
                  for (e = 0; e < t.length; e++)
                      ...
                      this.chart.addEventListener("dataAnimationIterationEnd", function() {
                          for (h = 0; h < t.length; h++)
                              c = t[h],
                              "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (g.ctx.save(),
                              g.ctx.beginPath(),
      ...
      D.prototype.createMask = function() {
          if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
              ...
              v ? (this.maskCanvas = va(this.chart.width, this.chart.height),
      ...
      D.prototype.renderAxisLine = function() {
          ...
          if ("bottom" === this._position || "top" === this._position) {
              if (this.lineThickness) {
                  ...
                  h = this.lineCoordinates.x1) : (e = this.lineCoordinates.x1,
                  ...
                  if (this.scaleBreaks && !p(this.scaleBreaks.firstBreakIndex))
                      if (p(this.scaleBreaks.lastBreakIndex))
                          ...
                          for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
                              g.moveTo(e, d),
                              g.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, d),
              ...
              h = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2,
      ...
      D.prototype.convertPixelToValue = function(a) {
          if ("undefined" === typeof a)
              return null;
          var g = 0, c = 0, b, g = !0, e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x;
          if (this.logarithmic) {
      ...
      D.prototype.getApparentDifference = function(a, g, c, b) {
          ...
          if (this.logarithmic) {
              ...
              for (c = p(c) ? Math.abs(g - a) : c,
              h = 0; h < e.length && !(g < e[h].startValue); h++)
      ...
      D.prototype.calculateValueToPixelConversionParameters = function(a) {
          ...
          if ("bottom" === this._position || "top" === this._position)
              ...
              g.pixelPerUnit = (this.reversed ? -1 : 1) * c * g.lnLogarithmBase / Math.log(Math.abs(b))) : g.pixelPerUnit = (this.reversed ? -1 : 1) * c / Math.abs(b),
      ...
      D.prototype.calculateAxisParameters = function() {
          if (this.logarithmic)
              ...
              if ("axisX" === this.type) {
                  ...
                  0 === h - e && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval,
                  h += b,
                  e -= b);
                  Infinity !== this.dataInfo.minDiff ? d = this.dataInfo.minDiff : 1 < h - e ? d = 0.5 * Math.abs(h - e) : (d = 1,
                  c && (g = !0))
              } else
                  "axisY" === this.type && (e = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
                  h = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
                  isFinite(e) || isFinite(h) ? isFinite(e) ? isFinite(h) || (h = e) : e = h : (h = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                  e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                  0 === e && 0 === h ? (h += 9,
                  e = 0) : 0 === h - e ? (b = Math.min(Math.abs(0.01 * Math.abs(h)), 5),
                  h += b,
                  e -= b) : e > h ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(h, e, null, !0)), 5),
                  0 <= h ? e = h - b : h = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, h, null, !0)), 0.05),
                  0 !== h && (h += b),
                  0 !== e && (e -= b)),
                  d = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < h - e ? 0.5 * Math.abs(h - e) : 1,
              ...
              if ("axisX" === this.type && c) {
                  ...
                  this.intervalType = "millisecond") : b / (1 * I.secondDuration) <= a ? (this.interval = 1,
                  this.intervalType = "second") : b / (2 * I.secondDuration) <= a ? (this.interval = 2,
                  this.intervalType = "second") : b / (5 * I.secondDuration) <= a ? (this.interval = 5,
                  this.intervalType = "second") : b / (10 * I.secondDuration) <= a ? (this.interval = 10,
                  this.intervalType = "second") : b / (15 * I.secondDuration) <= a ? (this.interval = 15,
                  this.intervalType = "second") : b / (20 * I.secondDuration) <= a ? (this.interval = 20,
                  this.intervalType = "second") : b / (30 * I.secondDuration) <= a ? (this.interval = 30,
                  this.intervalType = "second") : b / (1 * I.minuteDuration) <= a ? (this.interval = 1,
                  this.intervalType = "minute") : b / (2 * I.minuteDuration) <= a ? (this.interval = 2,
                  this.intervalType = "minute") : b / (5 * I.minuteDuration) <= a ? (this.interval = 5,
                  this.intervalType = "minute") : b / (10 * I.minuteDuration) <= a ? (this.interval = 10,
                  this.intervalType = "minute") : b / (15 * I.minuteDuration) <= a ? (this.interval = 15,
                  this.intervalType = "minute") : b / (20 * I.minuteDuration) <= a ? (this.interval = 20,
                  this.intervalType = "minute") : b / (30 * I.minuteDuration) <= a ? (this.interval = 30,
                  this.intervalType = "minute") : b / (1 * I.hourDuration) <= a ? (this.interval = 1,
                  this.intervalType = "hour") : b / (2 * I.hourDuration) <= a ? (this.interval = 2,
                  this.intervalType = "hour") : b / (3 * I.hourDuration) <= a ? (this.interval = 3,
                  this.intervalType = "hour") : b / (6 * I.hourDuration) <= a ? (this.interval = 6,
                  this.intervalType = "hour") : b / (1 * I.dayDuration) <= a ? (this.interval = 1,
                  this.intervalType = "day") : b / (2 * I.dayDuration) <= a ? (this.interval = 2,
                  this.intervalType = "day") : b / (4 * I.dayDuration) <= a ? (this.interval = 4,
                  this.intervalType = "day") : b / (1 * I.weekDuration) <= a ? (this.interval = 1,
                  this.intervalType = "week") : b / (2 * I.weekDuration) <= a ? (this.interval = 2,
                  this.intervalType = "week") : b / (3 * I.weekDuration) <= a ? (this.interval = 3,
                  this.intervalType = "week") : b / (1 * I.monthDuration) <= a ? (this.interval = 1,
                  this.intervalType = "month") : b / (2 * I.monthDuration) <= a ? (this.interval = 2,
                  this.intervalType = "month") : b / (3 * I.monthDuration) <= a ? (this.interval = 3,
                  this.intervalType = "month") : b / (6 * I.monthDuration) <= a ? (this.interval = 6,
                  this.intervalType = "month") : (this.interval = b / (1 * I.yearDuration) <= a ? 1 : b / (2 * I.yearDuration) <= a ? 2 : b / (4 * I.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / I.yearDuration),
                  ...
                  if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                      this.viewportMinimum = "axisX" === this.type ? e - d / 2 : Math.floor(e / this.interval) * this.interval;
                  if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
                      this.viewportMaximum = "axisX" === this.type ? h + d / 2 : Math.ceil(h / this.interval) * this.interval;
              ...
              if (null === this.minimum || null === this.maximum)
                  ...
                  h += b,
                  e -= b),
                  d = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < h - e ? 0.5 * Math.abs(h - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min,
                  h = null !== this.maximum ? this.maximum : this.dataInfo.max,
                  isFinite(e) || isFinite(h) ? 0 === e && 0 === h ? (h += 9,
                  e = 0) : 0 === h - e ? (b = Math.min(Math.abs(0.01 * Math.abs(h)), 5),
                  h += b,
                  e -= b) : e > h ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(h, e, null, !0)), 5),
                  0 <= h ? e = h - b : h = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, h, null, !0)), 0.05),
                  0 !== h && (h += b),
                  0 !== e && (e -= b)) : (h = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                  e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                  d = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < h - e ? 0.5 * Math.abs(h - e) : 1,
                  ...
                  "axisX" === this.type && c) {
                      ...
                      null === this.minimum && (this.minimum = "axisX" === this.type ? e - d / 2 : Math.floor(e / this.interval) * this.interval,
                      this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
      ...
      D.prototype.calculateLogarithmicAxisParameters = function() {
          ...
          1 === e / b && (d = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval),
          e *= d,
          b /= d),
          h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
          e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
          ...
          b = 1) : 1 === e / b ? (d = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
          e *= d,
          b /= d) : b > e ? (d = Math.min(b / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
          1 <= e ? b = e / d : e = b * d) : (d = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
          1 !== e && (e *= d),
          1 !== b && (b /= d)),
          ...
          this.intervalType = "number";
          d = Math.pow(this.logarithmBase, D.getNiceNumber(Math.abs(Math.log(d) / g), !1));
          this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = D.getNiceExponent(Math.log(d) / g / (a - 1), !0),
          ...
          this.options && "undefined" === typeof this.options.interval && (this.interval = D.getNiceExponent(Math.ceil(Math.log(d) / g) / (a - 1)),
          ...
          if (null === this.minimum || null === this.maximum)
              ...
              e *= d,
              b /= d),
              h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.minimum ? this.minimum : this.dataInfo.min,
              e = null !== this.maximum ? this.maximum : this.dataInfo.max,
              isFinite(b) || isFinite(e) ? 1 === b && 1 === e ? (e *= this.logarithmBase,
              b /= this.logarithmBase) : 1 === e / b ? (d = Math.pow(this.logarithmBase, this.interval),
              e *= d,
              b /= d) : b > e ? (d = Math.min(0.01 * (b / e), 5),
              1 <= e ? b = e / d : e = b * d) : (d = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
              1 !== e && (e *= d),
              1 !== b && (b /= d)) : (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval,
              b = 1),
              h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
              ...
              this.intervalType = "number",
              null === this.minimum && (this.minimum = "axisX" === this.type ? b / Math.sqrt(h) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(b) / g / this.interval)),
              ...
              null === this.maximum && (this.maximum = "axisX" === this.type ? e * Math.sqrt(h) : Math.pow(this.logarithmBase, this.interval * Math.ceil(Math.log(e) / g / this.interval)),
      ...
      D.getNiceNumber = function(a, g) {
          var c = Math.floor(Math.log(a) / Math.LN10)
            , b = a / Math.pow(10, c)
            , b = g ? 1.5 > b ? 1 : 3 > b ? 2 : 7 > b ? 5 : 10 : 1 >= b ? 1 : 2 >= b ? 2 : 5 >= b ? 5 : 10;
          return -20 > c ? Number(b * Math.pow(10, c)) : Number((b * Math.pow(10, c)).toFixed(20))
      }
      ;
      ...
      ga.prototype.render = function(a) {
          if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
              ...
              if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                  ...
                  p = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
                  ...
                  l = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
      ...
      ca.prototype.showAt = function(a) {
          ...
          for (b = 0; b < g.axisX.length; b++)
              ...
              g.axisX[b].crosshair && (g.axisX[b].crosshair.enabled && !p(a) && a >= g.axisX[b].viewportMinimum && a <= g.axisX[b].viewportMaximum) && (g.axisX[b].showCrosshair(a),
              g.axisX[b].crosshair._updatedValue = a,
              this === g.axisX[b].crosshair && (c = !0));
          for (b = 0; b < g.axisX2.length; b++)
              a = g.axisX2[b]._crosshairValue,
              g.axisX2[b].crosshair && (g.axisX2[b].crosshair.enabled && !p(a) && a >= g.axisX2[b].viewportMinimum && a <= g.axisX2[b].viewportMaximum) && (g.axisX2[b].showCrosshair(a),
              g.axisX2[b].crosshair._updatedValue = a,
              this === g.axisX2[b].crosshair && (c = !0));
          for (b = 0; b < g.axisY.length; b++)
              a = g.axisY[b]._crosshairValue,
              g.axisY[b].crosshair && (g.axisY[b].crosshair.enabled && !p(a) && a >= g.axisY[b].viewportMinimum && a <= g.axisY[b].viewportMaximum) && (g.axisY[b].showCrosshair(a),
              g.axisY[b].crosshair._updatedValue = a,
              this === g.axisY[b].crosshair && (c = !0));
          for (b = 0; b < g.axisY2.length; b++)
              a = g.axisY2[b]._crosshairValue,
              g.axisY2[b].crosshair && (g.axisY2[b].crosshair.enabled && !p(a) && a >= g.axisY2[b].viewportMinimum && a <= g.axisY2[b].viewportMaximum) && (g.axisY2[b].showCrosshair(a),
      ...
      ca.prototype.render = function(a, g, c) {
          var b, e, d, l, t = null, v = null, k = null, m = "";
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  ...
                  for (var s = 0; s < this.parent.dataSeries.length; s++)
                      (y = this.parent.dataSeries[s].getDataPointAtX(w, !0)) && 0 <= y.index && (y.dataSeries = this.parent.dataSeries[s],
                      ...
                      if ("rangeBar" === m[s].dataSeries.type || "error" === m[s].dataSeries.type) {
                          if (m[s].dataPoint.y)
                              for (var E = 0; E < m[s].dataPoint.y.length; E++)
                                  z = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y[E])),
                                  z <= w && (w = z,
                                  y = s)
                      } else
                          "stackedBar" === m[s].dataSeries.type ? (cumulativeY = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY,
                          z = Math.abs(a - this.parent.convertValueToPixel(cumulativeY)),
                          z <= w && (w = z,
                          ...
                          z <= u && (u = z,
                          y = s)) : (z = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y)),
                          z <= w && (w = z,
                          y = s));
                      p(u) || (w = Math.min(w, u))
                  }
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      if ("rangeBar" === u.dataSeries.type || "error" === u.dataSeries.type) {
                          ...
                          for (m = 0; m < u.dataPoint.y.length; m++)
                              z = Math.abs(a - this.parent.convertValueToPixel(u.dataPoint.y[m])),
                              z < w && (w = z,
                              s = m);
                          ...
                          }) : p(this.options.label) ? da(p(c) ? u.dataPoint.y[s] : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                      } else
                          "stackedBar" === u.dataSeries.type ? (w = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                          cumulativeY = u.dataSeries.dataPointEOs[u.index].cumulativeY,
                          t = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(cumulativeY) << 0) + 0.5 : this.parent.convertValueToPixel(cumulativeY) << 0,
                          ...
                          k.text = this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: cumulativeY
                          }) : p(this.options.label) ? da(p(c) ? cumulativeY : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : "stackedBar100" === u.dataSeries.type ? (w = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                          cumulativeY = u.dataSeries.dataPointEOs[u.index].cumulativeY,
                          z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x,
                          yPercent = 100 * (cumulativeY / u.dataSeries.plotUnit.dataPointYSums[z]),
                          t = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(yPercent) << 0) + 0.5 : this.parent.convertValueToPixel(yPercent) << 0,
                          this.value = yPercent,
                          k.text = this.labelFormatter ? this.labelFormatter({
                              chart: this.chart,
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: yPercent
                          }) : p(this.options.label) ? da(p(c) ? yPercent : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : (t = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataPoint.y) << 0,
                          ...
                          k.text = this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: u.dataPoint.y
                          }) : p(this.options.label) ? da(p(c) ? u.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                      b = e = t;
                      ...
                      d = l = v = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataPoint.x) << 0;
                      ...
                      if (this.parent.labels)
                          ...
                          m = 0; m < this.parent.viewportMaximum; m += w)
                      ...
                      if (s) {
                          if ("axisX" === this.parent.type)
                              ...
                              s = 0; s < this.parent.dataSeries.length; s++)
                                  (y = this.parent.dataSeries[s].getDataPointAtX(w, !0)) && 0 <= y.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                      chart: this.chart,
                                      axis: this.parent.options,
                                      crosshair: this.options,
                                      value: u.dataPoint.x
                          ...
                          k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: u.dataPoint.x
                          }) : p(this.options.label) ? da(u.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                              chart: this.chart,
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: u.dataPoint.x
                          }) : p(this.options.label) ? Ca(u.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label;
                  ...
                  u = m[0];
                  b = e = t = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataPoint.x) << 0;
                  d = this.chart.plotArea.y1;
                  l = this.chart.plotArea.y2;
                  this.bounds = {
                      x1: b - n / 2,
                      ...
                      if ("rangeColumn" === m[s].dataSeries.type || "rangeArea" === m[s].dataSeries.type || "error" === m[s].dataSeries.type || "rangeSplineArea" === m[s].dataSeries.type || "candlestick" === m[s].dataSeries.type || "ohlc" === m[s].dataSeries.type || "boxAndWhisker" === m[s].dataSeries.type) {
                          if (m[s].dataPoint.y)
                              for (E = 0; E < m[s].dataPoint.y.length; E++)
                                  z = Math.abs(g - this.parent.convertValueToPixel(m[s].dataPoint.y[E])),
                                  z <= w && (w = z,
                                  y = s)
                      } else
                          "stackedColumn" === m[s].dataSeries.type ? (b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY,
                          z = Math.abs(g - this.parent.convertValueToPixel(b)),
                          z <= w && (w = z,
                          y = s)) : "stackedArea" === m[s].dataSeries.type ? (b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY,
                          z = Math.abs(g - this.parent.convertValueToPixel(b)),
                          z <= w && (w = z,
                          y = s)) : "stackedColumn100" === m[s].dataSeries.type || "stackedArea100" === m[s].dataSeries.type ? (z = m[0].dataPoint.x.getTime ? m[0].dataPoint.x.getTime() : m[0].dataPoint.x,
                          p(u) && (u = Math.abs(g - this.parent.convertValueToPixel(100 * (m[0].dataSeries.dataPointEOs[m[0].index].cumulativeY / m[0].dataSeries.plotUnit.dataPointYSums[z])))),
                          "stackedColumn100" === m[s].dataSeries.type ? (v = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY,
                          z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x,
                          b = 100 * (v / m[s].dataSeries.plotUnit.dataPointYSums[z]),
                          z = Math.abs(g - this.parent.convertValueToPixel(b)),
                          z <= u && (u = z,
                          y = s)) : "stackedArea100" === m[s].dataSeries.type && (v = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY,
                          z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x,
                          b = 100 * (v / m[s].dataSeries.plotUnit.dataPointYSums[z]),
                          z = Math.abs(g - this.parent.convertValueToPixel(b)),
                          z <= u && (u = z,
                          y = s))) : "waterfall" === m[s].dataSeries.type ? (z = Math.abs(g - this.parent.convertValueToPixel(m[s].dataSeries.dataPointEOs[m[s].index].cumulativeSum)),
                          z <= w && (u = w = z,
                          y = s)) : (z = Math.abs(g - this.parent.convertValueToPixel(m[s].dataPoint.y)),
                          z <= w && (w = z,
                          y = s));
                      p(u) || (w = Math.min(w, u))
                  }
                  ...
                  if ("rangeColumn" === u.dataSeries.type || "rangeArea" === u.dataSeries.type || "error" === u.dataSeries.type || "rangeSplineArea" === u.dataSeries.type || "candlestick" === u.dataSeries.type || "ohlc" === u.dataSeries.type || "boxAndWhisker" === u.dataSeries.type) {
                      ...
                      for (m = 0; m < u.dataPoint.y.length; m++)
                          z = Math.abs(g - this.parent.convertValueToPixel(u.dataPoint.y[m])),
                          z < w && (w = z,
                          s = m);
                      v = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataPoint.y[s]) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataPoint.y[s]) << 0;
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                      ...
                      "stackedColumn" === u.dataSeries.type ? (b = u.dataSeries.dataPointEOs[u.index].cumulativeY,
                      v = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: b
                      }) : p(this.options.label) ? da(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                      ...
                      this.value = b) : "waterfall" === u.dataSeries.type ? (v = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataSeries.dataPointEOs[u.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataSeries.dataPointEOs[u.index].cumulativeSum) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: u.dataSeries.dataPointEOs[u.index].cumulativeSum
                      }) : p(this.options.label) ? da(p(c) ? u.dataSeries.dataPointEOs[u.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                      this.value = u.dataSeries.dataPointEOs[u.index].cumulativeSum) : (v = 1 === f.lineWidth % 2 ? (p(a) ? g : this.parent.convertValueToPixel(u.dataPoint.y) << 0) + 0.5 : p(a) ? g : this.parent.convertValueToPixel(u.dataPoint.y) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position)
                  ...
                  this.value >= Math.min(this.parent.viewportMinimum, this.parent.viewportMaximum) && this.value <= Math.max(this.parent.viewportMinimum, this.parent.viewportMaximum) && 0 < n && (f.moveTo(b, d),
                  f.lineTo(e, l),
                  f.stroke(),
                  this._hidden = !1);
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                  if ("left" === this.parent._position || "right" === this.parent._position) {
                      ...
                      if (s) {
                          ...
                          }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                              chart: this.chart,
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: p(c) ? this.parent.convertPixelToValue(g) : c
                          }) : p(this.options.label) ? Ca(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                  ...
                  if (s) {
                      ...
                      }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: p(c) ? this.parent.convertPixelToValue(a) : c
                  ...
                  k.text = this.labelFormatter ? this.labelFormatter({
                      ...
                      crosshair: this.options,
                      value: p(c) ? this.parent.convertPixelToValue(g) : c
                  }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                  k.y = g + k.fontSize / 2 - k.measureText().height / 2 + 2,
                  k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2),
                  "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
      ...
      V.prototype._initialize = function() {
          ...
          if (this.enabled) {
              ...
              v || (a.style.filter = "alpha(opacity = 90)",
              ...
              if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                  ...
                  if (this.chart.axisX)
                      for (var A = 0; A < this.chart.axisX.length; A++) {
                          for (var l = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[A].convertPixelToValue({
                              y: g
                          }) : this.chart.axisX[A].convertPixelToValue({
                              x: a
                          }), k = null, b = 0; b < this.chart.axisX[A].dataSeries.length; b++)
                              (k = this.chart.axisX[A].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[A].dataSeries[b],
                              null !== k.dataPoint.y && k.dataSeries.visible && t.push(k));
                          k = null
                      }
                  if (this.chart.axisX2)
                      for (A = 0; A < this.chart.axisX2.length; A++) {
                          l = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[A].convertPixelToValue({
                              y: g
                          }) : this.chart.axisX2[A].convertPixelToValue({
                              x: a
                          });
                          k = null;
                          for (b = 0; b < this.chart.axisX2[A].dataSeries.length; b++)
                              (k = this.chart.axisX2[A].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[A].dataSeries[b],
                              null !== k.dataPoint.y && k.dataSeries.visible && t.push(k));
                          k = null
                      }
                  if (0 === t.length)
                  ...
                  for (b = 0; b < t.length; b++)
                      t[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && d.push(t[b]);
                  t = null
              } else {
                  if (b = this.chart.getDataPointAtXY(a, g, c))
                      ...
                      if (b = ab(a, g, this.chart._eventManager.ghostCtx),
                      ...
                      if (!p(k) && !p(k.dataPoint) && !p(k.dataPoint.y))
                          if (k.dataSeries.axisY)
                              if (0 < k.dataPoint.y.length) {
                                  ...
                                  "column" === e.type || "bar" === e.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && d.push(k) : k.dataSeries.axisY.viewportMinimum <= k.dataPoint.y && 0 <= k.dataSeries.axisY.viewportMaximum && d.push(k) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2,
                                  k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - c && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + c && d.push(k)) : "waterfall" === e.type ? (c = 0,
                                  ...
                                  2 > c && -2 < c && d.push(k)) : (0 <= k.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum) && d.push(k);
                          else
                              d.push(k)
                  }
              }
              if (0 < d.length) {
                  if (this.highlightObjects(d),
                  this.enabled) {
                      c = "";
                      ...
                      if (null !== c) {
                          ...
                          if (this.isToolTipDefinedInData && p(this.options.content) && p(this.options.contentFormatter))
                              for (l = this.contentDiv.getElementsByTagName("span"),
                              b = 0; b < l.length; b++)
                                  l[b] && (l[b].style.color = l[b].getAttribute("data-color"));
                          l = !1;
                          "none" === this.container.style.display && (l = !0,
                          ...
                          g = 1 !== d.length || this.shared || "line" !== d[0].dataSeries.type && "stepLine" !== d[0].dataSeries.type && "spline" !== d[0].dataSeries.type && "area" !== d[0].dataSeries.type && "stepArea" !== d[0].dataSeries.type && "splineArea" !== d[0].dataSeries.type ? "bar" === d[0].dataSeries.type || "rangeBar" === d[0].dataSeries.type || "stackedBar" === d[0].dataSeries.type || "stackedBar100" === d[0].dataSeries.type ? d[0].dataSeries.axisX.convertValueToPixel(d[0].dataPoint.x) : g : d[0].dataSeries.axisY.convertValueToPixel(d[0].dataPoint.y);
                          g = -g + 10;
      ...
      V.prototype.highlightObjects = function(a) {
          ...
          for (c = 0; c < a.length; c++) {
              ...
              if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                  ...
                  d.borderThickness = d.borderThickness || Math.ceil(0.1 * d.size),
                  Y.drawMarkers([d]),
                  "undefined" !== typeof e.y2 && (d = b.getMarkerProperties(l, e.x1, e.y2, this.chart.overlaidCanvasCtx),
                  d.size = Math.max(1.5 * d.size << 0, 10),
                  d.borderColor = d.borderColor || "#FFFFFF",
                  d.borderThickness = d.borderThickness || Math.ceil(0.1 * d.size),
                  Y.drawMarkers([d]))) : "bubble" === b.type ? (d = b.getMarkerProperties(l, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                  d.size = e.size,
                  d.color = "white",
                  d.borderColor = "white",
                  g.globalAlpha = 0.3,
                  Y.drawMarkers([d]),
                  g.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ea(g, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? qa(g, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? sa(g, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (g.globalAlpha = 1,
                  ...
                  g.stroke(),
                  ea(g, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                  g.globalAlpha = 1) : "ohlc" === b.type ? (g.globalAlpha = 1,
                  g.strokeStyle = e.color,
                  g.lineWidth = 2 * e.borderThickness,
                  b = 0 === g.lineWidth % 2 ? 0 : 0.5,
                  g.beginPath(),
                  ...
                  g.lineTo(e.x2, e.y4),
                  g.stroke(),
                  g.globalAlpha = 1) : "boxAndWhisker" === b.type ? (g.save(),
                  g.globalAlpha = 1,
                  g.strokeStyle = e.stemColor,
                  g.lineWidth = 2 * e.stemThickness,
                  0 < e.stemThickness && (g.beginPath(),
                  ...
                  g.stroke()),
                  g.beginPath(),
                  ea(g, e.x1, Math.max(e.y2, e.y3), e.x2, Math.min(e.y2, e.y3), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                  g.globalAlpha = 1,
                  g.strokeStyle = e.whiskerColor,
                  g.lineWidth = 2 * e.whiskerThickness,
                  0 < e.whiskerThickness && (g.beginPath(),
                  ...
                  0 < e.lineThickness && (g.beginPath(),
                  g.moveTo(e.x1, e.y5),
                  g.lineTo(e.x2, e.y5),
                  g.stroke()),
                  g.restore(),
                  g.globalAlpha = 1) : "error" === b.type && A(g, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
              }
          }
          g.restore();
          g.globalAlpha = 1;
      ...
      V.prototype.getToolTipInnerHTML = function(a) {
          ...
          if (this.isToolTipDefinedInData && (this.content && "function" === typeof this.content || this.contentFormatter))
              ...
              for (var p = null, t = "", l = 0; l < a.length; l++) {
                  ...
                  null === d && (d = ""),
                  c.visible && (!0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(h, b, c, e) + d,
                  l < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(h, b, c, e),
                  l < a.length - 1 && (d += "</br>"))))
              }
              null !== d && (d = t + d)
          } else {
          ...
          if ("mousemove" === a.type || "click" === a.type) {
              ...
              if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b])
                  ...
                  "dataPoint" === b.objectType) {
                      ...
                      h = null !== b.dataPointIndex ? e.dataPoints[b.dataPointIndex] : null,
                      b.eventParameter = {
                          x: c.x,
                          y: c.y,
                          dataSeries: e.options,
      ...
      W.prototype.fireEvent = function(a, d, c) {
          if (a && d) {
              ...
              "mouseout" !== d ? h.cursor && h.cursor !== c.target.style.cursor && (c.target.style.cursor = h.cursor) : (c.target.style.cursor = this.chart.panEnabled ? "itemmouseout" !== e.mouseout || h.dockInsidePlotArea ? "move" : this.chart._defaultCursor : this.chart._defaultCursor,
        ...
        , Y = {
          drawMarker: function(a, d, c, b, e, h, l, p) {
              if (c) {
                  ...
                  h && c.fill(),
                  p && (l ? c.stroke() : (t = c.globalAlpha,
                  c.globalAlpha = 0.15,
                  c.strokeStyle = "black",
                  c.stroke(),
                  c.globalAlpha = t))) : "square" === b ? (c.beginPath(),
                  ...
                  c.strokeStyle = "black",
                  c.stroke(),
                  c.globalAlpha = t))) : "triangle" === b ? (c.beginPath(),
...
/*eslint-enable*/
/*jshint ignore:end*/
export const CanvasJS = window.CanvasJS;