...
function gtm_ProductClick(n, t, i, r, u, f, e, o = "false") {
    var s, h;
    if (dataLayer === undefined) {
        console.log("dataLayer chÆ°a khai bĂ¡o");
        return
    ...
    gbl_siteId !== undefined && (gbl_siteId == 1 ? s[0].dimension88 = o === undefined || o === "false" ? "No" : "Yes" : gbl_siteId == 2 && (s[0].dimension79 = o === undefined || o === "false" ? "No" : "Yes"));
    h = {
        ecommerce: {
            click: {
                products: s,
...
function ShowProductBHX() {
    setTimeout(function () {
        $.ajax({
            ...
            beforeSend: function () { },
            success: function (n) {
                n != "" && n.status == 1 ? ($("#showPromoteBHX").html(n.message), $(".footer").css("margin-top", 10), $(".prmotebanner-bhx-footer").owlCarousel({
                    items: 5,
                    slideSpeed: 5e3,
                    nav: !0,
                    dots: !1,
                ...
                }), CheckBoxBHX(), $("#form-zone-bhx button").click(function (n) {
                    n.preventDefault();
                    pdbxbhxapi.sendCoupon()
                })) : $(".zone-bhx").remove()
            },
...
function suggestSearch(n) {
    ...
    } else n.type == "submit" ? goToSearchPage(t) : searching || isHasSub || (clearTimeout(timmer), timmer = setTimeout(function () {
        callSuggestSearch(n)
    }, 600))
}

function goToSearchPage(n, t) {
    var i, e = n.toString().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|_|-|\(|\)|{|}|\[|\]|\\|\|/gi, ""),
        f = e.trim(),
        r = encodeURIComponent(f).replace(/\./g, "+").replace(/%20/gi, "+").replace(/ /g, "+"),
        u;
    t !== undefined && t > 0 && (r = r + "&cate=" + t);
    $(".header__search .dropdownsearch").length > 0 ? (u = $(".header__search .dropdownsearch a").data("id"), u == 1 ? i = "/game-app/tim-kiem?key=" + r : u == 2 ? i = "/tim-kiem?key=" + r : u == 3 && (i = "/tin-tuc/tim-kiem?key=" + r)) : location.href.indexOf(".com/may-doi-tra") > 0 ? i = "/may-doi-tra/tim-kiem?key=" + r : location.href.indexOf(".com/tin-tuc") > 0 ? i = "/tin-tuc/tim-kiem?key=" + r : location.href.indexOf(".com/game-app") > 0 ? i = "/game-app/tim-kiem?key=" + r : (i = "/tim-kiem?key=" + r, UpdateSearchKeywordHistory(f, urlRoot + i));
    location.href = i
}
var ConditionOperator, AutoComplete, laodBHX, loadBHX, isLoadPopupLocation, IsLoadingPersonalize, IsLoadingSuggest, keyViewedHistory, container, Summiting, bannerTopIndexKey, isRandomBannerTop, pdbxbhxapi, onloadCallbackcaptcha_1318718959;
! function (n, t) {
    "use strict";
...
var urlRoot = "https://localhost:44370",
    isHasSub = !1,
    isSearchHis = !0,
    isMobile = !1,
    isCallFastDeli = !1,
...
pdbxbhxapi = {
    ...
    validEmail: function () {
        ...
        return t ? ($(".voucherproduct-bhx input[name=email]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").addClass("hidden"), !0) : ($(".voucherproduct-bhx .voucher-error").text("Email khĂ´ng Ä‘Ăºng Ä‘á»‹nh dáº¡ng"), $(".voucherproduct-bhx .voucher-error").removeClass("hidden"), $(".voucherproduct-bhx input[name=email]").addClass("input-warning"), !1)
    },
    validPhone: function () {
        var n = $(".voucherproduct-bhx input[name=phone]").val(),
            t = pdbxbhxapi.checkPhone(n);
        return t ? ($(".voucherproduct-bhx input[name=phone]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").addClass("hidden"), !0) : ($(".voucherproduct-bhx .voucher-error span").text("Sá»‘ Ä‘iá»‡n thoáº¡i khĂ´ng Ä‘Ăºng Ä‘á»‹nh dáº¡ng"), $(".voucherproduct-bhx input[name=phone]").addClass("input-warning"), $(".voucherproduct-bhx .voucher-error").removeClass("hidden"), !1)
    },
    sendCoupon: function () {
        ...
        if (!pdbxbhxapi.loading) {
            ...
            $.ajax({
                ...
                success: function (t) {
                    ...
                    } else $(".voucherproduct-bhx .voucher-error").text(t.message), $(".voucherproduct-bhx .voucher-error").removeClass("hidden"), isMobile && ($(".productbox-bhxapi div._voucher").addClass("hide-voucher-note"), $(".voucherproduct-bhx .voucher-note").hide())
                },
                error: function () {
    ...
    checkValid: function (n) {
        ...
        if (n == "email" || n == undefined) {
            if (i == "") return $(".voucherproduct-bhx .voucher-error").text("Email khĂ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng"), $(".voucherproduct-bhx .voucher-error").removeClass("hidden"), $(".voucherproduct-bhx input[name=email]").addClass("input-warning"), $(".voucherproduct-bhx button").attr("disabled", "disabled"), !1;
            if (t = pdbxbhxapi.validEmail(), !t) return $(".voucherproduct-bhx button").attr("disabled", "disabled"), !1
        }
        if (n == "phone" || n == undefined) {
            if (r == "") return $(".voucherproduct-bhx .voucher-error").text("Sá»‘ Ä‘iá»‡n thoáº¡i khĂ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng"), $(".voucherproduct-bhx .voucher-error").removeClass("hidden"), $(".voucherproduct-bhx input[name=phone]").addClass("input-warning"), $(".voucherproduct-bhx button").attr("disabled", "disabled"), !1;
            if (t = pdbxbhxapi.validPhone(), !t) return $(".voucherproduct-bhx button").attr("disabled", "disabled"), !1
        }
        return n == "email" && r != "" && (t = pdbxbhxapi.validPhone(), !t) ? ($(".voucherproduct-bhx button").attr("disabled", "disabled"), !1) : n == "phone" && i != "" && (t = pdbxbhxapi.validEmail(), !t) ? ($(".voucherproduct-bhx button").attr("disabled", "disabled"), !1) : r != "" && i != "" ? ($(".voucherproduct-bhx .voucher-error").addClass("hidden"), $(".voucherproduct-bhx input").removeClass("input-warning"), $(".voucherproduct-bhx button").removeAttr("disabled"), !0) : void 0
    },
    ...
    checkActiveSubmit: function () {
        ...
        pdbxbhxapi.checkPhone(n) && pdbxbhxapi.checkEmail(t) && ($(".voucherproduct-bhx button").removeAttr("disabled"), $(".voucherproduct-bhx .voucher-error").addClass("hidden"), $(".voucherproduct-bhx input").removeClass("input-warning"));
        pdbxbhxapi.checkPhone(n) && ($(".voucherproduct-bhx input[name=phone]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").text().indexOf("Sá»‘ Ä‘iá»‡n thoáº¡i") != -1 && $(".voucherproduct-bhx .voucher-error").addClass("hidden"));
        pdbxbhxapi.checkEmail(t) && ($(".voucherproduct-bhx input[name=email]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").text().indexOf("Email") != -1 && $(".voucherproduct-bhx .voucher-error").addClass("hidden"))
    },
...
onloadCallbackcaptcha_1318718959 = function () {
    ...
    i = !1;
    n = !1;
    t.clone(!1, !1).unbind("click").on("click", function () {
        return n || (n = !0, pdbxbhxapi.sendCoupon(), setTimeout(() => {
            n = !1
        }, 5e3)), i
...
var intervalFS;
$('body').append('<div id="loadingDiv" class="loading-cart"><span class="cswrap"><span class="csdot"></span><span class="csdot"></span><span class="csdot"></span></span></div>');
...
function removeLoader() {
    if ($('body').hasClass("pace-running")) {
        ...
        $('.pace-progress').removeClass("pace-active").addClass("pace-inactive");
    }
    $("#loadingDiv").remove();
}
function initLayout() {
    ...
    $(".main-menu .phukien").hover(function () {
        $(".bg-black").length > 0 && closePopup()
    }, function () { });
    setTimeout(function () {
        var t = $(".linkversion").attr("href"),
            n;
        t != undefined && t.includes("issub") && (hrefnewdv = location.href, n = location.pathname + location.search, hrefnewdv = location.pathname.includes("?") ? urlRoot + n + "&sclient=mobile" + location.hash : urlRoot + n + "?sclient=mobile" + location.hash, $(".linkversion").attr("href", hrefnewdv))
    }, 600);
    $(".main-menu li").length > 0 && $(".main-menu li").each(function () {
        if (location.pathname.split("/")[1] == $(this).find("a").attr("href").replace("/", "")) return $(this).addClass("active"), !1
    });
    $(".header__listtop .divitem").length > 0 && $(".header__listtop .divitem").each(function () {
...
function slickFS() {
    $(".slider-flashsale .item").length > 12 && $(".slider-flashsale").data("mobile") != 1 && $(".slider-flashsale").not('.slick-initialized').slick({
        rows: 2,
        dots: !1,
        arrows: !0,
        infinite: !1,
...
function SliderFlashsale() {
    ...
    $(".listing-timeline a").click(function (n) {
        ...
        t.hasClass("active") || ($(".listing-timeline a").removeClass("active"), t.addClass("active"), $.ajax({
            url: urlRoot + "/api/Common/GetProductListFlashsale?promoId=" + t.data("promoid") + "&current=" + t.data("current") + "&host=" + urlRoot,
            cache: !1,
            type: "GET",
            beforeSend: function () {
